...
static Attr *handleLoopHintAttr(Sema &S, Stmt *St, const AttributeList &A,
  ...
  bool PragmaCGRA = PragmaNameLoc->Ident->getName() == "CGRA"; //Added for #pragma CGRA shail
  if (St->getStmtClass() != Stmt::DoStmtClass &&
    ...
    const char *Pragma =
	    ...
	    .Case("CGRA", "#pragma CGRA")	//Added for #pragma CGRA shail
  ...
  if (PragmaNoUnroll) {
    ...
    Spelling = LoopHintAttr::Pragma_CGRA; 
...
CheckForIncompatibleAttributes(Sema &S,
  ...
  for (const auto *I : Attrs) {
    ...
    enum { Vectorize, Interleave, Unroll, Distribute, CGRA } Category;	
    switch (Option) {
    ...
    case LoopHintAttr::Distribute:
      ...
      Category = Distribute;
      break;
    case LoopHintAttr::CGRA:	//added for #pragma CGRA shail
      Category = CGRA;
      break;
    };
    ...
    if (Option == LoopHintAttr::Vectorize ||
        ...
        Option == LoopHintAttr::Distribute || Option == LoopHintAttr::CGRA) {
