...
static MDNode *createMetadata(LLVMContext &Ctx, const LoopAttributes &Attrs,
  ...
  if (!Attrs.IsParallel && Attrs.VectorizeWidth == 0 &&
      ...
      Attrs.CGRAEnable == LoopAttributes::Unspecified &&	//added for #pragma CGRA shail
      !StartLoc && !EndLoc)
    return nullptr;
  ...
  if (Attrs.CGRAEnable != LoopAttributes::Unspecified) {
    std::string Name;
    if (Attrs.CGRAEnable == LoopAttributes::Enable) {
      Name = "llvm.loop.CGRA.enable";
    //else
      //Name = "llvm.loop.CGRA.disable";
      Metadata *Vals[] = {MDString::get(Ctx, Name)};
      Args.push_back(MDNode::get(Ctx, Vals));
    }
  }
...
LoopAttributes::LoopAttributes(bool IsParallel)
    : IsParallel(IsParallel), VectorizeEnable(LoopAttributes::Unspecified),
      ...
      DistributeEnable(LoopAttributes::Unspecified), CGRAEnable(LoopAttributes::Unspecified) {}
...
void LoopAttributes::clear() {
  ...
  CGRAEnable = LoopAttributes::Unspecified;
}
  ...
  for (const auto *Attr : Attrs) {
    ...
    case LoopHintAttr::Disable:
      ...
      case LoopHintAttr::CGRA:
        setCGRAState(LoopAttributes::Disable);
        break;
    ...
    case LoopHintAttr::Enable:
      ...
      case LoopHintAttr::Distribute:
        ...
        break;
      case LoopHintAttr::CGRA:
        setCGRAState(LoopAttributes::Enable);
        break;
      case LoopHintAttr::UnrollCount:
      case LoopHintAttr::VectorizeWidth:
      case LoopHintAttr::InterleaveCount:
