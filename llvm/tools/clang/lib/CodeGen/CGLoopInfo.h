...
struct LoopAttributes {
  ...
  /// \brief Value for llvm.loop.CGRA.enable metadata.	
  LVEnableState CGRAEnable;	//added for #pragma CGRA shail
...
public:
  ...
  /// \brief Set the next pushed loop as a candidate for acceleration over CGRA.
  void setCGRAState(const LoopAttributes::LVEnableState &State) {	//added for #pragma CGRA shail
    StagedAttrs.CGRAEnable = State;
  }
