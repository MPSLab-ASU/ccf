...
void Parser::initializePragmaHandlers() {
  ...
  CGRAHandler = std::make_unique<PragmaCGRAHandler>("CGRA");
...
bool Parser::HandlePragmaLoopHint(LoopHint &Hint) {
  ...
  auto IsLoopHint = llvm::StringSwitch<bool>(PragmaNameInfo->getName())
                        .Cases("unroll", "nounroll", "CGRA", "unroll_and_jam",
                               "nounroll_and_jam", "CGRA", true)
                        .Default(false);
...
void PragmaCGRAHandler::HandlePragma(Preprocessor &PP,
  ...
  if (Tok.is(tok::eod)) {
    ...
    std::cout << "ParseCGRAHandler else if(getName() == 'CGRA')\n";
    PP.Diag(Tok.getLocation(), diag::warn_pragma_extra_tokens_at_eol)
        << "CGRA";
    return;
  } 
