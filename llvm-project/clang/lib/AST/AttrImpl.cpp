...
void LoopHintAttr::printPrettyPragma(raw_ostream &OS,
  ...
  if (SpellingIndex == Pragma_nounroll ||
      ...
      SpellingIndex == Pragma_CGRA) {//added for #pragma CGRA
      //Arkan
    if(SpellingIndex == Pragma_CGRA) {
        std::cout << "LoopHintAttr::printPrettyPragma found Pragma_CGRA\n";
    }
    return;
  }
...
LoopHintAttr::getDiagnosticName(const PrintingPolicy &Policy) const {
  llvm::errs() << "LoopHintAttr::GetDiagnosticName Hit\n";
  unsigned SpellingIndex = getAttributeSpellingListIndex();
  llvm::errs() << SpellingIndex << "\n";
  if (SpellingIndex == Pragma_nounroll)
  ...
  else if (SpellingIndex == Pragma_CGRA) {
    llvm::errs() << "LoopHintAttr::getDiagnosticName returning with #pragma CGRA\n";
    return "#pragma CGRA";
  }
