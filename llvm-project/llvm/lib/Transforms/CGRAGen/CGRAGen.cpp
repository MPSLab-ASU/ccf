...
namespace llvm
{
  struct CGRAGen: public ModulePass
  {
    ...
    virtual bool runOnFunction(Function &F) {
      if(DEBUG) errs() << "Inside CGRAGen runOnFunction\n";
      if(DEBUG) errs() << F.getName() << "\n";
      if(F.getName() == "main")
      {
