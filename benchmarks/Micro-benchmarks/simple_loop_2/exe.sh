...
# CGRA Execution
~/ccf/gem5/build/ARM/gem5.opt --debug-flags=Instruction_print,CGRA_Detailed ~/git_repos/ccf/gem5/configs/example/se_hetro.py -n 2 --cpu-type atomic  --cgra --cgra-type cgra"$X"x"$Y"r"$R" -c ./add_small -o "10" > output_small.txt
