; ModuleID = '/home/local/ASUAD/aabuyaz1/documents/code/ccf_1804/scripts/CGRALib/cgra.c'
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #0 !dbg !53 {
  ...
  br i1 %83, label %101, label %84, !dbg !234
...
92:                                               ; preds = %84
  ...
  br i1 %93, label %94, label %101, !dbg !254
...
96:                                               ; preds = %94, %90
  ...
  br i1 %100, label %101, label %84, !dbg !234, !llvm.loop !258

101:                                              ; preds = %96, %92, %1
  %102 = phi i32 [ 0, %1 ], [ %86, %92 ], [ %97, %96 ], !dbg !262
  %103 = phi i32 [ 0, %1 ], [ %85, %92 ], [ %98, %96 ], !dbg !154
  %104 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([39 x i8], [39 x i8]* @.str.15, i32 0, i32 0), i32 %103, i32 %102), !dbg !263
  call void @llvm.dbg.value(metadata i32 %60, metadata !140, metadata !DIExpression()), !dbg !154
...
define dso_local void @createCGRA() local_unnamed_addr #0 !dbg !481 {
  ...
  br i1 %15, label %22, label %16, !dbg !511
...
16:                                               ; preds = %0, %16
  ...
  br i1 %21, label %22, label %16, !dbg !511, !llvm.loop !515
...
!262 = !DILocation(line: 79, column: 15, scope: !53)
!263 = !DILocation(line: 93, column: 3, scope: !53)
