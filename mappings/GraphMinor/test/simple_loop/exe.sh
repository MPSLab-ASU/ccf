...
~/ccf/gem5/build/ARM/gem5.opt --debug-flags=CGRA,CGRA_Detailed ~/ccf/gem5/configs/example/se_hetro.py -n 2  --cpu-type atomic --cpu-clock $cpuclock --cgra --cgra-type cgra"$X"x"$Y"r"$R" --cgra-clock $cgraclock -c ./add > output.txt
