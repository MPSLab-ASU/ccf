...
class DFG
{
  ...
  public:
    ...
    int Modulo_Route_ReSchedule(int &id, int number_of_resources, int II, vector<Node*> &to_change_set, vector<Node*> &route_node);

    tuple<bool, int, int>   Modulo_Schedule_Routing(int II, int Last_Time, bool &multiple_constraint, int number_of_resources, vector<Node*> to_schedule, int* PEs);
