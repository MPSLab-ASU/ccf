...
void Scheduling_Info::set_Schedule_ASAP(int time)
{
    Schedule_ASAP = time;
}

void Scheduling_Info::set_Schedule_ALAP(int time)
{
    Schedule_ALAP = time;
}
void Scheduling_Info::set_Schedule_time(int time)
{
...
int Scheduling_Info::get_Schedule_time()
{
  return schedule_time; 
}

int Scheduling_Info::get_Schedule_ASAP()
{
  return Schedule_ASAP;
}

int Scheduling_Info::get_Schedule_ALAP()
{
  return Schedule_ALAP;
}
...
void Scheduling_Info::reset_all()
{
    ASAP = -1;
    ALAP = -1;
    CURRENT = -1;
