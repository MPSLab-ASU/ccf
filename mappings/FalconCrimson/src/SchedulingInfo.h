...
class Scheduling_Info
{
  ...
  public:
    ...
    void set_Schedule_time(int time);
    void set_Schedule_ASAP(int time);
    void set_Schedule_ALAP(int time);
    void reset_Current();
    ...
    int get_Schedule_ASAP();
    int get_Schedule_ALAP();
