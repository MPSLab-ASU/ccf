...
class Mapper
{
  public:
    ...
    vector<vector<Cover_Pair*> > MapWithRegisterFile(char *table, int tableSize, int cliqueSize, int II);
    ...
    vector<vector<Cover_Pair*> > MapWithoutRegisterFile(char *table, int tableSize, int cliqueSize, int II);
