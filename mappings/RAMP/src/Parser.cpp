...
*
*
*  Last Edited on: Sept 30, 2020 
*  Author: Mahesh Balasubramanian
*  Update: Datatype for each operation.
*/
...
bool Parser::ParseDFG(DFG* myDFG)
{
  ...
  if (fin_node.is_open())
  {
    while (fin_node.getline(&line[0], 255, '\n'))
    {
      ...
      //if(nodeName == "ft_tab" || nodeName.find("gVar") != string::npos || nodeName.find("gPtr") != string::npos || nodeName.find("dmy_CGRAst") != string::npos || nodeName.find("amb_temp") != string::npos)
        //nodeName = "ConstInt0";
