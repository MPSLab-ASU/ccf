...
; <label>:7:                                      ; preds = %2
  ...
  br i1 %12, label %.preheader2.preheader, label %108
...
.preheader2:                                      ; preds = %.preheader2.preheader, %.loopexit
  %15 = phi double [ %62, %.loopexit ], [ 0x7FEFFFFFFFFFFFFF, %.preheader2.preheader ]
  %16 = phi i32 [ %65, %.loopexit ], [ undef, %.preheader2.preheader ]
  %17 = phi i32 [ %61, %.loopexit ], [ undef, %.preheader2.preheader ]
  %18 = phi i32 [ %69, %.loopexit ], [ 0, %.preheader2.preheader ]
  %19 = phi double [ %64, %.loopexit ], [ 0.000000e+00, %.preheader2.preheader ]
  %20 = tail call i32 @clock() #5
  %21 = icmp eq i32 %18, 1
  %22 = tail call i32 @rand() #5
  br i1 %21, label %.preheader.preheader, label %97
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %24 = lshr <4 x i32> %vec.ind, <i32 1, i32 1, i32 1, i32 1>
  %25 = and <4 x i32> %24, <i32 1431655765, i32 1431655765, i32 1431655765, i32 1431655765>
  %26 = and <4 x i32> %vec.ind, <i32 1431655765, i32 1431655765, i32 1431655765, i32 1431655765>
  %27 = add nuw <4 x i32> %25, %26
  %28 = lshr <4 x i32> %27, <i32 2, i32 2, i32 2, i32 2>
  %29 = and <4 x i32> %28, <i32 858993459, i32 858993459, i32 858993459, i32 858993459>
  %30 = and <4 x i32> %27, <i32 858993459, i32 858993459, i32 858993459, i32 858993459>
  %31 = add nuw nsw <4 x i32> %29, %30
  %32 = lshr <4 x i32> %31, <i32 4, i32 4, i32 4, i32 4>
  %33 = and <4 x i32> %32, <i32 117901063, i32 117901063, i32 117901063, i32 117901063>
  %34 = and <4 x i32> %31, <i32 117901063, i32 117901063, i32 117901063, i32 117901063>
  %35 = add nuw nsw <4 x i32> %33, %34
  %36 = lshr <4 x i32> %35, <i32 8, i32 8, i32 8, i32 8>
  %37 = and <4 x i32> %36, <i32 983055, i32 983055, i32 983055, i32 983055>
  %38 = and <4 x i32> %35, <i32 983055, i32 983055, i32 983055, i32 983055>
  %39 = add nuw nsw <4 x i32> %37, %38
  %40 = lshr <4 x i32> %39, <i32 16, i32 16, i32 16, i32 16>
  %41 = and <4 x i32> %39, <i32 31, i32 31, i32 31, i32 31>
  %42 = add <4 x i32> %41, %vec.phi
  %43 = add <4 x i32> %42, %40
  %index.next = add i32 %index, 4
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 52, i32 52, i32 52, i32 52>
  %44 = icmp eq i32 %index.next, %n.vec
  br i1 %44, label %middle.block, label %vector.body, !llvm.loop !35

middle.block:                                     ; preds = %vector.body
  %rdx.shuf = shufflevector <4 x i32> %43, <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
  %bin.rdx = add <4 x i32> %43, %rdx.shuf
  ...
  %45 = extractelement <4 x i32> %bin.rdx22, i32 0
  br i1 %cmp.n, label %.loopexit, label %.preheader.preheader23

; <label>:46:                                     ; preds = %97, %46
  %47 = phi i32 [ %22, %97 ], [ %53, %46 ]
  %48 = phi i32 [ 0, %97 ], [ %51, %46 ]
  %49 = phi i32 [ 0, %97 ], [ %52, %46 ]
  %50 = tail call i32 %99(i32 %47) #5
  %51 = add nsw i32 %50, %48
  %52 = add nuw nsw i32 %49, 1
  %53 = add nsw i32 %47, 13
  %54 = icmp eq i32 %52, %10
  br i1 %54, label %.loopexit.loopexit26, label %46, !llvm.loop !86

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit.loopexit26:                             ; preds = %46
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit26, %.loopexit.loopexit, %middle.block
  %55 = phi i32 [ %45, %middle.block ], [ %93, %.loopexit.loopexit ], [ %51, %.loopexit.loopexit26 ]
  %56 = tail call i32 @clock() #5
  %57 = sub nsw i32 %56, %20
  %58 = sitofp i32 %57 to double
  %59 = fdiv double %58, 1.000000e+06
  %60 = fcmp olt double %59, %15
  %61 = select i1 %60, i32 %18, i32 %17
  %62 = select i1 %60, double %59, double %15
  %63 = fcmp ogt double %59, %19
  %64 = select i1 %63, double %59, double %19
  %65 = select i1 %63, i32 %18, i32 %16
  %66 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %18
  %67 = load i8*, i8** %66, align 4, !tbaa !34
  %68 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* %67, double %59, i32 %55)
  %69 = add nuw nsw i32 %18, 1
  %70 = icmp eq i32 %69, 7
  br i1 %70, label %.loopexit3.loopexit, label %.preheader2, !llvm.loop !90

.preheader:                                       ; preds = %.preheader.preheader23, %.preheader
  %71 = phi i32 [ %95, %.preheader ], [ %.ph, %.preheader.preheader23 ]
  %72 = phi i32 [ %93, %.preheader ], [ %.ph24, %.preheader.preheader23 ]
  %73 = phi i32 [ %94, %.preheader ], [ %.ph25, %.preheader.preheader23 ]
  %74 = lshr i32 %71, 1
  %75 = and i32 %74, 1431655765
  %76 = and i32 %71, 1431655765
  %77 = add nuw i32 %75, %76
  %78 = lshr i32 %77, 2
  %79 = and i32 %78, 858993459
  %80 = and i32 %77, 858993459
  %81 = add nuw nsw i32 %79, %80
  %82 = lshr i32 %81, 4
  %83 = and i32 %82, 117901063
  %84 = and i32 %81, 117901063
  %85 = add nuw nsw i32 %83, %84
  %86 = lshr i32 %85, 8
  %87 = and i32 %86, 983055
  %88 = and i32 %85, 983055
  ...
  %95 = add nsw i32 %71, 13
  %96 = icmp eq i32 %94, %10
  br i1 %96, label %.loopexit.loopexit, label %.preheader, !llvm.loop !92

; <label>:97:                                     ; preds = %.preheader2
  %98 = getelementptr inbounds [7 x i32 (i32)*], [7 x i32 (i32)*]* @main.pBitCntFunc, i32 0, i32 %18
  %99 = load i32 (i32)*, i32 (i32)** %98, align 4, !tbaa !34
  br label %46

.loopexit3.loopexit:                              ; preds = %.loopexit
  br label %.loopexit3

.loopexit3:                                       ; preds = %.loopexit3.loopexit, %108
  %100 = phi i32 [ %192, %108 ], [ %61, %.loopexit3.loopexit ]
  %101 = phi i32 [ %194, %108 ], [ %65, %.loopexit3.loopexit ]
  %102 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %100
  %103 = load i8*, i8** %102, align 4, !tbaa !34
  %104 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.10, i32 0, i32 0), i8* %103)
  %105 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %101
  %106 = load i8*, i8** %105, align 4, !tbaa !34
  %107 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* %106)
  ret i32 0

; <label>:108:                                    ; preds = %7
  %109 = tail call i32 @clock() #5
  %110 = tail call i32 @rand() #5
  %111 = tail call i32 @clock() #5
  %112 = sub nsw i32 %111, %109
  %113 = sitofp i32 %112 to double
  %114 = fdiv double %113, 1.000000e+06
  %115 = fcmp olt double %114, 0x7FEFFFFFFFFFFFFF
  %116 = select i1 %115, double %114, double 0x7FEFFFFFFFFFFFFF
  %117 = fcmp ogt double %114, 0.000000e+00
  %118 = select i1 %117, double %114, double 0.000000e+00
  %119 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0), double %114, i32 0)
  %120 = tail call i32 @clock() #5
  %121 = tail call i32 @rand() #5
  %122 = tail call i32 @clock() #5
  %123 = sub nsw i32 %122, %120
  %124 = sitofp i32 %123 to double
  %125 = fdiv double %124, 1.000000e+06
  %126 = fcmp olt double %125, %116
  %127 = zext i1 %126 to i32
  %128 = select i1 %126, double %125, double %116
  %129 = fcmp ogt double %125, %118
  %130 = select i1 %129, double %125, double %118
  %131 = zext i1 %129 to i32
  %132 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1.2, i32 0, i32 0), double %125, i32 0)
  %133 = tail call i32 @clock() #5
  %134 = tail call i32 @rand() #5
  %135 = tail call i32 @clock() #5
  %136 = sub nsw i32 %135, %133
  %137 = sitofp i32 %136 to double
  %138 = fdiv double %137, 1.000000e+06
  %139 = fcmp olt double %138, %128
  %140 = select i1 %139, i32 2, i32 %127
  %141 = select i1 %139, double %138, double %128
  %142 = fcmp ogt double %138, %130
  %143 = select i1 %142, double %138, double %130
  %144 = select i1 %142, i32 2, i32 %131
  %145 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), double %138, i32 0)
  %146 = tail call i32 @clock() #5
  %147 = tail call i32 @rand() #5
  %148 = tail call i32 @clock() #5
  %149 = sub nsw i32 %148, %146
  %150 = sitofp i32 %149 to double
  %151 = fdiv double %150, 1.000000e+06
  %152 = fcmp olt double %151, %141
  %153 = select i1 %152, i32 3, i32 %140
  %154 = select i1 %152, double %151, double %141
  %155 = fcmp ogt double %151, %143
  %156 = select i1 %155, double %151, double %143
  %157 = select i1 %155, i32 3, i32 %144
  %158 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i32 0, i32 0), double %151, i32 0)
  %159 = tail call i32 @clock() #5
  %160 = tail call i32 @rand() #5
  %161 = tail call i32 @clock() #5
  %162 = sub nsw i32 %161, %159
  %163 = sitofp i32 %162 to double
  %164 = fdiv double %163, 1.000000e+06
  %165 = fcmp olt double %164, %154
  %166 = select i1 %165, i32 4, i32 %153
  %167 = select i1 %165, double %164, double %154
  %168 = fcmp ogt double %164, %156
  %169 = select i1 %168, double %164, double %156
  %170 = select i1 %168, i32 4, i32 %157
  %171 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %164, i32 0)
  %172 = tail call i32 @clock() #5
  %173 = tail call i32 @rand() #5
  %174 = tail call i32 @clock() #5
  %175 = sub nsw i32 %174, %172
  %176 = sitofp i32 %175 to double
  %177 = fdiv double %176, 1.000000e+06
  %178 = fcmp olt double %177, %167
  %179 = select i1 %178, i32 5, i32 %166
  %180 = select i1 %178, double %177, double %167
  %181 = fcmp ogt double %177, %169
  %182 = select i1 %181, double %177, double %169
  %183 = select i1 %181, i32 5, i32 %170
  %184 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.5, i32 0, i32 0), double %177, i32 0)
  %185 = tail call i32 @clock() #5
  %186 = tail call i32 @rand() #5
  %187 = tail call i32 @clock() #5
  %188 = sub nsw i32 %187, %185
  %189 = sitofp i32 %188 to double
  %190 = fdiv double %189, 1.000000e+06
  %191 = fcmp olt double %190, %180
  %192 = select i1 %191, i32 6, i32 %179
  %193 = fcmp ogt double %190, %182
  %194 = select i1 %193, i32 6, i32 %183
  %195 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), double %190, i32 0)
  br label %.loopexit3
}
...
define i32 @bit_count(i32) #7 {
  %2 = icmp eq i32 %0, 0
  br i1 %2, label %.loopexit, label %.preheader.preheader, !llvm.loop !94
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %7 = and i32 %6, %3
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %.loopexit.loopexit, label %.preheader, !llvm.loop !94
...
define i32 @initializeParameters(i32) local_unnamed_addr #2 {
  ...
  store i32 2011168768, i32* %17, align 4, !tbaa !111
  %18 = getelementptr inbounds i32, i32* %17, i32 1
  store i32 2011168768, i32* %18, align 4, !tbaa !111
  ...
  store i32 %71, i32* %76, align 4, !tbaa !111
  %77 = getelementptr inbounds i32, i32* %75, i32 3
  store i32 %72, i32* %77, align 4, !tbaa !111
  %78 = getelementptr inbounds i32, i32* %75, i32 4
  store i32 %73, i32* %78, align 4, !tbaa !111
  %79 = load i32, i32* %11, align 4, !tbaa !111
  %80 = sdiv i32 %79, 16
  %81 = getelementptr inbounds i32, i32* %75, i32 6
  store i32 %80, i32* %81, align 4, !tbaa !111
  ...
  store i32 %96, i32* %99, align 4, !tbaa !111
  ...
  store i32 %104, i32* %106, align 4, !tbaa !113
  ...
  store i32 %107, i32* %109, align 4, !tbaa !113
  ...
  store i32 %110, i32* %112, align 4, !tbaa !113
...
; <label>:16:                                     ; preds = %1
  %17 = load i32, i32* @dynamicTCVal, align 4, !tbaa !111
  ...
  store i32 %18, i32* %21, align 4, !tbaa !111
  br label %22
...
; <label>:22:                                     ; preds = %16, %1
  ...
  %29 = load i32, i32* %28, align 4, !tbaa !111
  ...
  %34 = load i32, i32* %33, align 4, !tbaa !111
  ...
  %39 = load i32, i32* %38, align 4, !tbaa !111
  ...
  %44 = load i32, i32* %43, align 4, !tbaa !111
  ...
  %54 = load i32, i32* %53, align 4, !tbaa !111
  ...
  %59 = load i32, i32* %58, align 4, !tbaa !111
  ...
  %63 = load i32, i32* %62, align 4, !tbaa !113
  ...
  %71 = load i32, i32* %70, align 4, !tbaa !113
...
; <label>:6:                                      ; preds = %1
  %7 = load i32, i32* @dynamicTCVal, align 4, !tbaa !111
  store i32 %7, i32* %3, align 4, !tbaa !111
  br label %8
...
; <label>:2:                                      ; preds = %11, %1
  %3 = load i32, i32* @thread_cond_cgra, align 4, !tbaa !111
  %4 = icmp eq i32 %3, 1
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %6 = load i32, i32* @thread_cond_cgra, align 4, !tbaa !111
  %7 = icmp eq i32 %6, 1
  br i1 %7, label %.loopexit.loopexit, label %.preheader, !llvm.loop !115

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %2
  %8 = load i32, i32* @thread_exit, align 4, !tbaa !111
  %9 = icmp eq i32 %8, 1
  br i1 %9, label %10, label %11

; <label>:10:                                     ; preds = %.loopexit
  tail call void asm sideeffect "mov r11,$0", "r"(i32 17) #5, !srcloc !163
  ret i8* null

; <label>:11:                                     ; preds = %.loopexit
  store i32 0, i32* @thread_cond_cgra, align 4, !tbaa !111
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #5, !srcloc !164
  %12 = tail call i32 @usleep(i32 1) #5
  store i32 1, i32* @thread_cond_cpu, align 4, !tbaa !111
...
define void @accelerateOnCGRA(i32) local_unnamed_addr #2 {
  ...
  store i32 0, i32* @thread_cond_cpu, align 4, !tbaa !111
  store i32 1, i32* @thread_cond_cgra, align 4, !tbaa !111
  br label %4

; <label>:4:                                      ; preds = %4, %1
  %5 = tail call i32 @usleep(i32 1) #5
  %6 = load i32, i32* @thread_cond_cpu, align 4, !tbaa !111
  %7 = icmp eq i32 %6, 1
  br i1 %7, label %8, label %4, !llvm.loop !167
...
define void @createCGRA() local_unnamed_addr #2 {
  ...
  call void @llvm.lifetime.end(i64 40, i8* nonnull %2) #5
  %6 = load i32, i32* @totalLoops, align 4, !tbaa !111
  %7 = mul i32 %6, 28
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %16 = add i32 %14, 1
  %17 = load i32, i32* @totalLoops, align 4, !tbaa !111
  %18 = icmp ugt i32 %16, %17
  br i1 %18, label %.loopexit.loopexit, label %.preheader, !llvm.loop !176
...
!92 = distinct !{!92, !36, !83, !93, !84, !85}
!93 = !{!"llvm.loop.unroll.runtime.disable"}
!94 = distinct !{!94, !95}
!95 = !DILocation(line: 18, column: 34, scope: !96)
!96 = distinct !DILexicalBlock(scope: !98, file: !97, line: 16, column: 13)
!97 = !DIFile(filename: "bitcnt_1.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount19")
!98 = distinct !DISubprogram(name: "bit_count", scope: !97, file: !97, line: 9, type: !57, isLocal: false, isDefinition: true, scopeLine: 10, flags: DIFlagPrototyped, isOptimized: true, unit: !99, variables: !100)
!99 = distinct !DICompileUnit(language: DW_LANG_C99, file: !97, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19)
!100 = !{!101, !102}
!101 = !DILocalVariable(name: "x", arg: 1, scope: !98, file: !97, line: 9, type: !16)
!102 = !DILocalVariable(name: "n", scope: !98, file: !97, line: 11, type: !17)
!103 = distinct !{!103, !104}
!104 = !DILocation(line: 93, column: 22, scope: !105)
!105 = distinct !DILexicalBlock(scope: !106, file: !38, line: 92, column: 3)
!106 = distinct !DISubprogram(name: "bit_shifter", scope: !38, file: !38, line: 88, type: !57, isLocal: true, isDefinition: true, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: true, unit: !48, variables: !107)
!107 = !{!108, !109, !110}
!108 = !DILocalVariable(name: "x", arg: 1, scope: !106, file: !38, line: 88, type: !16)
!109 = !DILocalVariable(name: "i", scope: !106, file: !38, line: 90, type: !17)
!110 = !DILocalVariable(name: "n", scope: !106, file: !38, line: 90, type: !17)
!111 = !{!112, !112, i64 0}
!112 = !{!"int", !6, i64 0}
!113 = !{!114, !114, i64 0}
!114 = !{!"long", !6, i64 0}
!115 = distinct !{!115, !116}
!116 = !DILocation(line: 223, column: 46, scope: !117)
!117 = distinct !DILexicalBlock(scope: !119, file: !118, line: 220, column: 14)
!118 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount19")
!119 = distinct !DISubprogram(name: "runOnCGRA", scope: !118, file: !118, line: 217, type: !120, isLocal: false, isDefinition: true, scopeLine: 218, flags: DIFlagPrototyped, isOptimized: true, unit: !122, variables: !161)
!120 = !DISubroutineType(types: !121)
!121 = !{!51, !51}
!122 = distinct !DICompileUnit(language: DW_LANG_C99, file: !118, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19, retainedTypes: !123, globals: !127)
!123 = !{!124, !125, !16, !51, !126}
...
!126 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !17, size: 32)
!127 = !{!128, !131, !133, !135, !137, !139, !141, !143, !145, !147, !150, !152, !154, !156}
!128 = !DIGlobalVariableExpression(var: !129)
!129 = distinct !DIGlobalVariable(name: "totalLoops", scope: !122, file: !130, line: 27, type: !125, isLocal: false, isDefinition: true)
!130 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount19")
!131 = !DIGlobalVariableExpression(var: !132)
!132 = distinct !DIGlobalVariable(name: "thread_cond_cpu", scope: !122, file: !130, line: 30, type: !125, isLocal: false, isDefinition: true)
!133 = !DIGlobalVariableExpression(var: !134)
!134 = distinct !DIGlobalVariable(name: "thread_cond_cgra", scope: !122, file: !130, line: 31, type: !125, isLocal: false, isDefinition: true)
!135 = !DIGlobalVariableExpression(var: !136)
!136 = distinct !DIGlobalVariable(name: "thread_exit", scope: !122, file: !130, line: 32, type: !125, isLocal: false, isDefinition: true)
!137 = !DIGlobalVariableExpression(var: !138)
!138 = distinct !DIGlobalVariable(name: "dynamicTCVal", scope: !122, file: !130, line: 34, type: !17, isLocal: false, isDefinition: true)
!139 = !DIGlobalVariableExpression(var: !140)
!140 = distinct !DIGlobalVariable(name: "prolog", scope: !122, file: !130, line: 21, type: !124, isLocal: false, isDefinition: true)
!141 = !DIGlobalVariableExpression(var: !142)
!142 = distinct !DIGlobalVariable(name: "epilog", scope: !122, file: !130, line: 21, type: !124, isLocal: false, isDefinition: true)
!143 = !DIGlobalVariableExpression(var: !144)
!144 = distinct !DIGlobalVariable(name: "kernel", scope: !122, file: !130, line: 21, type: !124, isLocal: false, isDefinition: true)
!145 = !DIGlobalVariableExpression(var: !146)
!146 = distinct !DIGlobalVariable(name: "ArrPtr", scope: !122, file: !130, line: 22, type: !124, isLocal: false, isDefinition: true)
!147 = !DIGlobalVariableExpression(var: !148)
!148 = distinct !DIGlobalVariable(name: "prologPtr", scope: !122, file: !130, line: 24, type: !149, isLocal: false, isDefinition: true)
!149 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !16, size: 32)
!150 = !DIGlobalVariableExpression(var: !151)
!151 = distinct !DIGlobalVariable(name: "kernelPtr", scope: !122, file: !130, line: 24, type: !149, isLocal: false, isDefinition: true)
!152 = !DIGlobalVariableExpression(var: !153)
!153 = distinct !DIGlobalVariable(name: "epilogPtr", scope: !122, file: !130, line: 24, type: !149, isLocal: false, isDefinition: true)
!154 = !DIGlobalVariableExpression(var: !155)
!155 = distinct !DIGlobalVariable(name: "initCGRA", scope: !122, file: !130, line: 26, type: !126, isLocal: false, isDefinition: true)
!156 = !DIGlobalVariableExpression(var: !157)
!157 = distinct !DIGlobalVariable(name: "pth", scope: !122, file: !130, line: 29, type: !158, isLocal: false, isDefinition: true)
!158 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !159, line: 37, baseType: !160)
!159 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount19")
!160 = !DIBasicType(name: "long unsigned int", size: 32, encoding: DW_ATE_unsigned)
!161 = !{!162}
!162 = !DILocalVariable(name: "arg", arg: 1, scope: !119, file: !118, line: 217, type: !51)
!163 = !{i32 6148}
!164 = !{i32 7183}
!165 = distinct !{!165, !166}
!166 = !DILocation(line: 257, column: 5, scope: !119)
!167 = distinct !{!167, !168}
!168 = !DILocation(line: 277, column: 41, scope: !169)
!169 = distinct !DISubprogram(name: "accelerateOnCGRA", scope: !118, file: !118, line: 261, type: !170, isLocal: false, isDefinition: true, scopeLine: 262, flags: DIFlagPrototyped, isOptimized: true, unit: !122, variables: !172)
!170 = !DISubroutineType(types: !171)
!171 = !{null, !125}
!172 = !{!173, !174, !175}
!173 = !DILocalVariable(name: "loopNo", arg: 1, scope: !169, file: !118, line: 261, type: !125)
!174 = !DILocalVariable(name: "result", scope: !169, file: !118, line: 263, type: !17)
!175 = !DILocalVariable(name: "configure", scope: !169, file: !118, line: 266, type: !17)
!176 = distinct !{!176, !177}
!177 = !DILocation(line: 314, column: 29, scope: !178)
!178 = distinct !DILexicalBlock(scope: !179, file: !118, line: 313, column: 3)
!179 = distinct !DISubprogram(name: "createCGRA", scope: !118, file: !118, line: 293, type: !180, isLocal: false, isDefinition: true, scopeLine: 294, isOptimized: true, unit: !122, variables: !182)
!180 = !DISubroutineType(types: !181)
!181 = !{null}
!182 = !{!183, !184}
!183 = !DILocalVariable(name: "result", scope: !179, file: !118, line: 303, type: !17)
!184 = !DILocalVariable(name: "i", scope: !179, file: !118, line: 304, type: !125)
