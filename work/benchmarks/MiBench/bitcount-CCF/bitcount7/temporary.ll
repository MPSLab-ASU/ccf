...
; <label>:150:                                    ; preds = %396, %15
  %151 = phi i32 [ %407, %396 ], [ %97, %15 ]
  %152 = phi i32 [ %409, %396 ], [ %99, %15 ]
...
; <label>:185:                                    ; preds = %.loopexit38.loopexit
  %186 = load i32, i32* @gVar11
  br label %.loopexit38

.loopexit38:                                      ; preds = %185, %middle.block
  %.lcssa31 = phi i32 [ %149, %middle.block ], [ %186, %185 ]
  %187 = fcmp ogt double %120, 0.000000e+00
  %188 = select i1 %121, double %120, double 0x7FEFFFFFFFFFFFFF
  %189 = select i1 %187, double %120, double 0.000000e+00
  %190 = tail call i32 @clock() #5
  %191 = sub nsw i32 %190, %123
...
; <label>:199:                                    ; preds = %199, %.loopexit38
  ...
  br i1 %207, label %208, label %199, !llvm.loop !97
...
; <label>:221:                                    ; preds = %221, %208
  ...
  br i1 %273, label %274, label %221, !llvm.loop !98
...
; <label>:288:                                    ; preds = %288, %274
  ...
  br i1 %316, label %317, label %288, !llvm.loop !99
...
; <label>:317:                                    ; preds = %288
  ...
  %328 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %325, i32 %gVar6)
  %329 = tail call i32 @clock() #5
  %330 = tail call i32 @rand() #5
  store i32 %330, i32* @gVar1
  %331 = sub i32 %10, 0
  %332 = sdiv i32 %331, 1
  store i32 %332, i32* @dynamicTCVal
  br label %333

; <label>:333:                                    ; preds = %333, %317
  %334 = phi i32 [ %330, %317 ], [ %360, %333 ]
  %335 = phi i32 [ 0, %317 ], [ %358, %333 ]
  %336 = phi i32 [ 0, %317 ], [ %359, %333 ]
  %337 = lshr i32 %334, 8
  %338 = lshr i32 %334, 16
  %339 = lshr i32 %334, 24
  %340 = and i32 %334, 255
  ...
  %348 = and i32 %338, 255
  %349 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %348
  %350 = load i8, i8* %349, align 1, !tbaa !5
  %351 = zext i8 %350 to i32
  %352 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %339
  ...
  %360 = add nsw i32 %334, 13
  %361 = icmp eq i32 %359, %10
  br i1 %361, label %362, label %333, !llvm.loop !99

; <label>:362:                                    ; preds = %333
  %363 = select i1 %284, i32 3, i32 %318
  %364 = select i1 %326, i32 4, i32 %319
  %365 = select i1 %327, double %325, double %320
  %366 = select i1 %326, double %325, double %321
  %367 = tail call i32 @clock() #5
  %368 = sub nsw i32 %367, %329
  %369 = sitofp i32 %368 to double
  %370 = fdiv double %369, 1.000000e+06
  %371 = fcmp olt double %370, %366
  %372 = fcmp ogt double %370, %365
  %gVar3 = load i32, i32* @gVar3
  %373 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.5, i32 0, i32 0), double %370, i32 %gVar3)
  %374 = tail call i32 @clock() #5
  %375 = tail call i32 @rand() #5
  br label %376

; <label>:376:                                    ; preds = %.loopexit, %362
  %377 = phi i32 [ %375, %362 ], [ %394, %.loopexit ]
  %378 = phi i32 [ 0, %362 ], [ %392, %.loopexit ]
  %379 = phi i32 [ 0, %362 ], [ %393, %.loopexit ]
  %380 = icmp eq i32 %377, 0
  br i1 %380, label %.loopexit, label %.preheader.preheader

.preheader.preheader:                             ; preds = %376
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %381 = phi i32 [ %385, %.preheader ], [ 0, %.preheader.preheader ]
  %382 = phi i32 [ %386, %.preheader ], [ 0, %.preheader.preheader ]
  %383 = phi i32 [ %387, %.preheader ], [ %377, %.preheader.preheader ]
  %384 = and i32 %383, 1
  %385 = add nsw i32 %384, %381
  %386 = add nuw nsw i32 %382, 1
  %387 = ashr i32 %383, 1
  %388 = icmp ne i32 %387, 0
  %389 = icmp ult i32 %386, 32
  %390 = and i1 %389, %388
  br i1 %390, label %.preheader, label %.loopexit.loopexit, !llvm.loop !100

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %376
  %391 = phi i32 [ 0, %376 ], [ %385, %.loopexit.loopexit ]
  %392 = add nsw i32 %391, %378
  %393 = add nuw nsw i32 %379, 1
  %394 = add nsw i32 %377, 13
  %395 = icmp eq i32 %393, %10
  br i1 %395, label %396, label %376, !llvm.loop !108

; <label>:396:                                    ; preds = %.loopexit
  %397 = select i1 %327, i32 4, i32 %363
  %398 = select i1 %371, i32 5, i32 %364
  %399 = select i1 %372, double %370, double %365
  %400 = select i1 %371, double %370, double %366
  %401 = select i1 %372, i32 5, i32 %397
  %402 = tail call i32 @clock() #5
  %403 = sub nsw i32 %402, %374
  %404 = sitofp i32 %403 to double
  %405 = fdiv double %404, 1.000000e+06
  %406 = fcmp olt double %405, %400
  %407 = select i1 %406, i32 6, i32 %398
  %408 = fcmp ogt double %405, %399
  %409 = select i1 %408, i32 6, i32 %401
  %410 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), double %405, i32 %392)
  br label %150
}
...
!94 = distinct !{!94, !47, !95, !96, !92, !93}
!95 = !{!"llvm.loop.CGRA.enable"}
!96 = !{!"llvm.loop.unroll.runtime.disable"}
!97 = distinct !{!97, !47, !90}
!98 = distinct !{!98, !47, !90}
!99 = distinct !{!99, !47, !95}
!100 = distinct !{!100, !101}
!101 = !DILocation(line: 85, column: 22, scope: !102)
!102 = distinct !DILexicalBlock(scope: !103, file: !49, line: 84, column: 3)
!103 = distinct !DISubprogram(name: "bit_shifter", scope: !49, file: !49, line: 80, type: !40, isLocal: true, isDefinition: true, scopeLine: 81, flags: DIFlagPrototyped, isOptimized: true, unit: !57, variables: !104)
!104 = !{!105, !106, !107}
!105 = !DILocalVariable(name: "x", arg: 1, scope: !103, file: !49, line: 80, type: !16)
!106 = !DILocalVariable(name: "i", scope: !103, file: !49, line: 82, type: !17)
!107 = !DILocalVariable(name: "n", scope: !103, file: !49, line: 82, type: !17)
!108 = distinct !{!108, !47, !90}
!109 = !{!110, !110, i64 0}
!110 = !{!"int", !6, i64 0}
!111 = !{!112, !112, i64 0}
!112 = !{!"long", !6, i64 0}
...
!116 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount7")
...
!128 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount7")
...
!157 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount7")
!158 = !DIBasicType(name: "long unsigned int", size: 32, encoding: DW_ATE_unsigned)
!159 = !{!160}
!160 = !DILocalVariable(name: "arg", arg: 1, scope: !117, file: !116, line: 217, type: !60)
!161 = !{i32 6148}
!162 = !{i32 7183}
