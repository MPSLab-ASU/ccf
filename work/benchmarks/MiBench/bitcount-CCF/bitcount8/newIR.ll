...
bit_count.exit.loopexit:                          ; preds = %.preheader.i
  %.lcssa7 = phi i32 [ %107, %.preheader.i ]
  br label %bit_count.exit

bit_count.exit:                                   ; preds = %bit_count.exit.loopexit, %.preheader1
  %111 = phi i32 [ 0, %.preheader1 ], [ %.lcssa7, %bit_count.exit.loopexit ]
...
; <label>:116:                                    ; preds = %bit_count.exit
  %.lcssa8 = phi i32 [ %112, %bit_count.exit ]
  ...
  %122 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0), double %120, i32 %.lcssa8)
...
middle.block:                                     ; preds = %vector.body
  %.lcssa6 = phi <4 x i32> [ %147, %vector.body ]
  %rdx.shuf = shufflevector <4 x i32> %.lcssa6, <4 x i32> undef, <4 x i32> <i32 2, i32 3, i32 undef, i32 undef>
  %bin.rdx = add <4 x i32> %.lcssa6, %rdx.shuf
...
; <label>:150:                                    ; preds = %385, %15
  %151 = phi i32 [ %396, %385 ], [ %97, %15 ]
  %152 = phi i32 [ %398, %385 ], [ %99, %15 ]
...
.loopexit38.loopexit:                             ; preds = %scalar.ph
  %.lcssa5 = phi i32 [ %181, %scalar.ph ]
  br label %.loopexit38

.loopexit38:                                      ; preds = %.loopexit38.loopexit, %middle.block
  %.lcssa31 = phi i32 [ %149, %middle.block ], [ %.lcssa5, %.loopexit38.loopexit ]
...
; <label>:206:                                    ; preds = %197
  ...
  %216 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), double %213, i32 %.lcssa4)
...
; <label>:272:                                    ; preds = %219
  ...
  %283 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i32 0, i32 0), double %280, i32 %.lcssa3)
...
; <label>:315:                                    ; preds = %286
  ...
  %326 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %323, i32 %.lcssa2)
...
; <label>:358:                                    ; preds = %329
  ...
  %369 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.5, i32 0, i32 0), double %366, i32 %.lcssa1)
  %370 = tail call i32 @clock() #5
  %371 = tail call i32 @rand() #5
  br label %372

; <label>:372:                                    ; preds = %.loopexit, %358
  %373 = phi i32 [ %371, %358 ], [ %383, %.loopexit ]
  %374 = phi i32 [ 0, %358 ], [ %381, %.loopexit ]
  %375 = phi i32 [ 0, %358 ], [ %382, %.loopexit ]
  %376 = icmp eq i32 %373, 0
  store i32 %373, i32* @gVar1
  br i1 %376, label %.loopexit, label %.preheader.preheader

.preheader.preheader:                             ; preds = %372
  br label %377

; <label>:377:                                    ; preds = %.preheader.preheader
...
; <label>:378:                                    ; preds = %.loopexit.loopexit
  %379 = load i32, i32* @gVar2
  br label %.loopexit

.loopexit:                                        ; preds = %378, %372
  %380 = phi i32 [ 0, %372 ], [ %379, %378 ]
  %381 = add nsw i32 %380, %374
  %382 = add nuw nsw i32 %375, 1
  %383 = add nsw i32 %373, 13
  %384 = icmp eq i32 %382, %10
  br i1 %384, label %385, label %372, !llvm.loop !46

; <label>:385:                                    ; preds = %.loopexit
  %.lcssa = phi i32 [ %381, %.loopexit ]
  %386 = select i1 %325, i32 4, i32 %359
  %387 = select i1 %367, i32 5, i32 %360
  %388 = select i1 %368, double %366, double %361
  %389 = select i1 %367, double %366, double %362
  %390 = select i1 %368, i32 5, i32 %386
  %391 = tail call i32 @clock() #5
  %392 = sub nsw i32 %391, %370
  %393 = sitofp i32 %392 to double
  %394 = fdiv double %393, 1.000000e+06
  %395 = fcmp olt double %394, %389
  %396 = select i1 %395, i32 6, i32 %387
  %397 = fcmp ogt double %394, %388
  %398 = select i1 %397, i32 6, i32 %390
  %399 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), double %394, i32 %.lcssa)
  br label %150
}
...
define i32 @initializeParameters(i32) local_unnamed_addr #2 {
  ...
  store i32 2011168768, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 0), align 4, !tbaa !95
  store i32 2011168768, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 1), align 4, !tbaa !95
  ...
  %65 = sdiv i32 %41, 16
  %66 = sdiv i32 %43, 16
  store i32 %64, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 2), align 4, !tbaa !95
  store i32 %65, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 3), align 4, !tbaa !95
  store i32 %66, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 4), align 4, !tbaa !95
  %67 = load i32, i32* %11, align 4, !tbaa !95
  %68 = sdiv i32 %67, 16
  store i32 %68, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 6), align 4, !tbaa !95
  ...
  store i32 0, i32* %13, align 4, !tbaa !95
  ...
  %81 = load i32, i32* %13, align 4, !tbaa !95
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i32 0, i32 0), i32 %81)
  %83 = load i32, i32* %13, align 4, !tbaa !95
  store i32 %83, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !95
  ...
  store i32 %88, i32* @prologPtr, align 4, !tbaa !97
  %89 = load i32, i32* bitcast (i32** @epilog to i32*), align 4, !tbaa !34
  store i32 %89, i32* @epilogPtr, align 4, !tbaa !97
  %90 = load i32, i32* bitcast (i32** @kernel to i32*), align 4, !tbaa !34
  store i32 %90, i32* @kernelPtr, align 4, !tbaa !97
...
define i32 @configureCGRA(i32) local_unnamed_addr #2 {
  ...
  %3 = alloca [20 x i8], align 1
  %4 = alloca [40 x i8], align 1
  %5 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !95
...
; <label>:11:                                     ; preds = %1
  %12 = load i32, i32* @dynamicTCVal, align 4, !tbaa !95
  %13 = add nsw i32 %12, %5
  store i32 %13, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !95
  br label %14
...
; <label>:14:                                     ; preds = %11, %1
  ...
  %19 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 0), align 4, !tbaa !95
  ...
  %21 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 1), align 4, !tbaa !95
  ...
  %23 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 2), align 4, !tbaa !95
  ...
  %25 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 3), align 4, !tbaa !95
  ...
  %27 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 4), align 4, !tbaa !95
  ...
  %29 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !95
  ...
  %31 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 6), align 4, !tbaa !95
  ...
  %33 = load i32, i32* @epilogPtr, align 4, !tbaa !97
  ...
  %35 = load i32, i32* @prologPtr, align 4, !tbaa !97
  ...
  %37 = load i32, i32* @kernelPtr, align 4, !tbaa !97
...
define void @updateLoopTC(i32) local_unnamed_addr #10 {
  %2 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !95
  %3 = icmp sgt i32 %2, 0
  br i1 %3, label %6, label %4

; <label>:4:                                      ; preds = %1
  %5 = load i32, i32* @dynamicTCVal, align 4, !tbaa !95
  store i32 %5, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !95
  br label %6
...
; <label>:2:                                      ; preds = %11, %1
  %3 = load i32, i32* @thread_cond_cgra, align 4, !tbaa !95
  %4 = icmp eq i32 %3, 1
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %6 = load i32, i32* @thread_cond_cgra, align 4, !tbaa !95
  %7 = icmp eq i32 %6, 1
  br i1 %7, label %.loopexit.loopexit, label %.preheader, !llvm.loop !99

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %2
  %8 = load i32, i32* @thread_exit, align 4, !tbaa !95
  %9 = icmp eq i32 %8, 1
  br i1 %9, label %10, label %11
...
; <label>:11:                                     ; preds = %.loopexit
  store i32 0, i32* @thread_cond_cgra, align 4, !tbaa !95
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #5, !srcloc !145
  %12 = tail call i32 @usleep(i32 1) #5
  store i32 1, i32* @thread_cond_cpu, align 4, !tbaa !95
...
define void @accelerateOnCGRA(i32) local_unnamed_addr #2 {
  ...
  store i32 0, i32* @thread_cond_cpu, align 4, !tbaa !95
  store i32 1, i32* @thread_cond_cgra, align 4, !tbaa !95
  br label %4

; <label>:4:                                      ; preds = %4, %1
  %5 = tail call i32 @usleep(i32 1) #5
  %6 = load i32, i32* @thread_cond_cpu, align 4, !tbaa !95
  %7 = icmp eq i32 %6, 1
  br i1 %7, label %8, label %4, !llvm.loop !148
...
!11 = !DIFile(filename: "bitstrng.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
...
!38 = !DIFile(filename: "bitcnt_1.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
...
!49 = !DIFile(filename: "bitcnts.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
...
!76 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/time.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!77 = !DIDerivedType(tag: DW_TAG_typedef, name: "__clock_t", file: !78, line: 135, baseType: !16)
!78 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/types.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
...
!98 = !{!"long", !6, i64 0}
!99 = distinct !{!99, !100}
!100 = !DILocation(line: 200, column: 46, scope: !101)
!101 = distinct !DILexicalBlock(scope: !103, file: !102, line: 197, column: 14)
!102 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!103 = distinct !DISubprogram(name: "runOnCGRA", scope: !102, file: !102, line: 194, type: !104, isLocal: false, isDefinition: true, scopeLine: 195, flags: DIFlagPrototyped, isOptimized: true, unit: !106, variables: !142)
!104 = !DISubroutineType(types: !105)
!105 = !{!60, !60}
!106 = distinct !DICompileUnit(language: DW_LANG_C99, file: !102, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19, retainedTypes: !107, globals: !110)
!107 = !{!108, !109, !16, !60}
...
!110 = !{!111, !114, !116, !118, !120, !122, !124, !126, !128, !130, !132, !134, !137}
!111 = !DIGlobalVariableExpression(var: !112)
!112 = distinct !DIGlobalVariable(name: "thread_cond_cpu", scope: !106, file: !113, line: 29, type: !109, isLocal: false, isDefinition: true)
!113 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!114 = !DIGlobalVariableExpression(var: !115)
!115 = distinct !DIGlobalVariable(name: "thread_cond_cgra", scope: !106, file: !113, line: 30, type: !109, isLocal: false, isDefinition: true)
!116 = !DIGlobalVariableExpression(var: !117)
!117 = distinct !DIGlobalVariable(name: "thread_exit", scope: !106, file: !113, line: 31, type: !109, isLocal: false, isDefinition: true)
!118 = !DIGlobalVariableExpression(var: !119)
!119 = distinct !DIGlobalVariable(name: "dynamicTCVal", scope: !106, file: !113, line: 33, type: !17, isLocal: false, isDefinition: true)
!120 = !DIGlobalVariableExpression(var: !121)
!121 = distinct !DIGlobalVariable(name: "prolog", scope: !106, file: !113, line: 21, type: !108, isLocal: false, isDefinition: true)
!122 = !DIGlobalVariableExpression(var: !123)
!123 = distinct !DIGlobalVariable(name: "epilog", scope: !106, file: !113, line: 21, type: !108, isLocal: false, isDefinition: true)
!124 = !DIGlobalVariableExpression(var: !125)
!125 = distinct !DIGlobalVariable(name: "kernel", scope: !106, file: !113, line: 21, type: !108, isLocal: false, isDefinition: true)
!126 = !DIGlobalVariableExpression(var: !127)
!127 = distinct !DIGlobalVariable(name: "ArrPtr", scope: !106, file: !113, line: 22, type: !108, isLocal: false, isDefinition: true)
!128 = !DIGlobalVariableExpression(var: !129)
!129 = distinct !DIGlobalVariable(name: "prologPtr", scope: !106, file: !113, line: 24, type: !16, isLocal: false, isDefinition: true)
!130 = !DIGlobalVariableExpression(var: !131)
!131 = distinct !DIGlobalVariable(name: "kernelPtr", scope: !106, file: !113, line: 24, type: !16, isLocal: false, isDefinition: true)
!132 = !DIGlobalVariableExpression(var: !133)
!133 = distinct !DIGlobalVariable(name: "epilogPtr", scope: !106, file: !113, line: 24, type: !16, isLocal: false, isDefinition: true)
!134 = !DIGlobalVariableExpression(var: !135)
!135 = distinct !DIGlobalVariable(name: "initCGRA", scope: !106, file: !113, line: 26, type: !136, isLocal: false, isDefinition: true)
!136 = !DICompositeType(tag: DW_TAG_array_type, baseType: !17, size: 224, elements: !66)
!137 = !DIGlobalVariableExpression(var: !138)
!138 = distinct !DIGlobalVariable(name: "pth", scope: !106, file: !113, line: 28, type: !139, isLocal: false, isDefinition: true)
!139 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !140, line: 37, baseType: !141)
!140 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!141 = !DIBasicType(name: "long unsigned int", size: 32, encoding: DW_ATE_unsigned)
!142 = !{!143}
!143 = !DILocalVariable(name: "arg", arg: 1, scope: !103, file: !102, line: 194, type: !60)
!144 = !{i32 5262}
!145 = !{i32 6297}
!146 = distinct !{!146, !147}
!147 = !DILocation(line: 234, column: 5, scope: !103)
!148 = distinct !{!148, !149}
!149 = !DILocation(line: 254, column: 41, scope: !150)
!150 = distinct !DISubprogram(name: "accelerateOnCGRA", scope: !102, file: !102, line: 238, type: !151, isLocal: false, isDefinition: true, scopeLine: 239, flags: DIFlagPrototyped, isOptimized: true, unit: !106, variables: !153)
!151 = !DISubroutineType(types: !152)
!152 = !{null, !109}
!153 = !{!154, !155, !156}
!154 = !DILocalVariable(name: "loopNo", arg: 1, scope: !150, file: !102, line: 238, type: !109)
!155 = !DILocalVariable(name: "result", scope: !150, file: !102, line: 240, type: !17)
!156 = !DILocalVariable(name: "configure", scope: !150, file: !102, line: 243, type: !17)
