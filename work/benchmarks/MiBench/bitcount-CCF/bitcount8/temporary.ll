...
; <label>:150:                                    ; preds = %394, %15
  %151 = phi i32 [ %405, %394 ], [ %97, %15 ]
  %152 = phi i32 [ %407, %394 ], [ %99, %15 ]
...
; <label>:372:                                    ; preds = %.loopexit, %358
  %373 = phi i32 [ %371, %358 ], [ %392, %.loopexit ]
  %374 = phi i32 [ 0, %358 ], [ %390, %.loopexit ]
  %375 = phi i32 [ 0, %358 ], [ %391, %.loopexit ]
...
; <label>:387:                                    ; preds = %.loopexit.loopexit
  %388 = load i32, i32* @gVar2
  br label %.loopexit

.loopexit:                                        ; preds = %387, %372
  %389 = phi i32 [ 0, %372 ], [ %388, %387 ]
  %390 = add nsw i32 %389, %374
  %391 = add nuw nsw i32 %375, 1
  %392 = add nsw i32 %373, 13
  %393 = icmp eq i32 %391, %10
  br i1 %393, label %394, label %372, !llvm.loop !46

; <label>:394:                                    ; preds = %.loopexit
  %395 = select i1 %325, i32 4, i32 %359
  %396 = select i1 %367, i32 5, i32 %360
  %397 = select i1 %368, double %366, double %361
  %398 = select i1 %367, double %366, double %362
  %399 = select i1 %368, i32 5, i32 %395
  %400 = tail call i32 @clock() #5
  %401 = sub nsw i32 %400, %370
...
define i32 @initializeParameters(i32) local_unnamed_addr #2 {
  ...
  store i32 2011168768, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 0), align 4, !tbaa !104
  store i32 2011168768, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 1), align 4, !tbaa !104
  ...
  %65 = sdiv i32 %41, 16
  %66 = sdiv i32 %43, 16
  store i32 %64, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 2), align 4, !tbaa !104
  store i32 %65, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 3), align 4, !tbaa !104
  store i32 %66, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 4), align 4, !tbaa !104
  %67 = load i32, i32* %11, align 4, !tbaa !104
  %68 = sdiv i32 %67, 16
  store i32 %68, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 6), align 4, !tbaa !104
  ...
  %81 = load i32, i32* %13, align 4, !tbaa !104
  %82 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i32 0, i32 0), i32 %81)
  %83 = load i32, i32* %13, align 4, !tbaa !104
  store i32 %83, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !104
  ...
  store i32 %88, i32* @prologPtr, align 4, !tbaa !106
  %89 = load i32, i32* bitcast (i32** @epilog to i32*), align 4, !tbaa !34
  store i32 %89, i32* @epilogPtr, align 4, !tbaa !106
  %90 = load i32, i32* bitcast (i32** @kernel to i32*), align 4, !tbaa !34
  store i32 %90, i32* @kernelPtr, align 4, !tbaa !106
...
define i32 @configureCGRA(i32) local_unnamed_addr #2 {
  ...
  %3 = alloca [20 x i8], align 1
  %4 = alloca [40 x i8], align 1
  %5 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !104
...
; <label>:11:                                     ; preds = %1
  %12 = load i32, i32* @dynamicTCVal, align 4, !tbaa !104
  %13 = add nsw i32 %12, %5
  store i32 %13, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !104
  br label %14
...
; <label>:14:                                     ; preds = %11, %1
  ...
  %19 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 0), align 4, !tbaa !104
  ...
  %21 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 1), align 4, !tbaa !104
  ...
  %23 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 2), align 4, !tbaa !104
  ...
  %25 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 3), align 4, !tbaa !104
  ...
  %27 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 4), align 4, !tbaa !104
  ...
  %29 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !104
  ...
  %31 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 6), align 4, !tbaa !104
  ...
  %33 = load i32, i32* @epilogPtr, align 4, !tbaa !106
  ...
  %35 = load i32, i32* @prologPtr, align 4, !tbaa !106
  ...
  %37 = load i32, i32* @kernelPtr, align 4, !tbaa !106
...
define void @updateLoopTC(i32) local_unnamed_addr #10 {
  %2 = load i32, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !104
  %3 = icmp sgt i32 %2, 0
  br i1 %3, label %6, label %4

; <label>:4:                                      ; preds = %1
  %5 = load i32, i32* @dynamicTCVal, align 4, !tbaa !104
  store i32 %5, i32* getelementptr inbounds ([7 x i32], [7 x i32]* @initCGRA, i32 0, i32 5), align 4, !tbaa !104
  br label %6
...
; <label>:10:                                     ; preds = %.loopexit
  tail call void asm sideeffect "mov r11,$0", "r"(i32 17) #5, !srcloc !153
  ret i8* null

; <label>:11:                                     ; preds = %.loopexit
  store i32 0, i32* @thread_cond_cgra, align 4, !tbaa !104
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #5, !srcloc !154
...
; <label>:4:                                      ; preds = %4, %1
  ...
  %7 = icmp eq i32 %6, 1
  br i1 %7, label %8, label %4, !llvm.loop !157
...
!103 = !{!"llvm.loop.CGRA.enable"}
!104 = !{!105, !105, i64 0}
!105 = !{!"int", !6, i64 0}
!106 = !{!107, !107, i64 0}
!107 = !{!"long", !6, i64 0}
!108 = distinct !{!108, !109}
!109 = !DILocation(line: 200, column: 46, scope: !110)
!110 = distinct !DILexicalBlock(scope: !112, file: !111, line: 197, column: 14)
!111 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!112 = distinct !DISubprogram(name: "runOnCGRA", scope: !111, file: !111, line: 194, type: !113, isLocal: false, isDefinition: true, scopeLine: 195, flags: DIFlagPrototyped, isOptimized: true, unit: !115, variables: !151)
!113 = !DISubroutineType(types: !114)
!114 = !{!60, !60}
!115 = distinct !DICompileUnit(language: DW_LANG_C99, file: !111, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19, retainedTypes: !116, globals: !119)
!116 = !{!117, !118, !16, !60}
...
!119 = !{!120, !123, !125, !127, !129, !131, !133, !135, !137, !139, !141, !143, !146}
!120 = !DIGlobalVariableExpression(var: !121)
!121 = distinct !DIGlobalVariable(name: "thread_cond_cpu", scope: !115, file: !122, line: 29, type: !118, isLocal: false, isDefinition: true)
!122 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!123 = !DIGlobalVariableExpression(var: !124)
!124 = distinct !DIGlobalVariable(name: "thread_cond_cgra", scope: !115, file: !122, line: 30, type: !118, isLocal: false, isDefinition: true)
!125 = !DIGlobalVariableExpression(var: !126)
!126 = distinct !DIGlobalVariable(name: "thread_exit", scope: !115, file: !122, line: 31, type: !118, isLocal: false, isDefinition: true)
!127 = !DIGlobalVariableExpression(var: !128)
!128 = distinct !DIGlobalVariable(name: "dynamicTCVal", scope: !115, file: !122, line: 33, type: !17, isLocal: false, isDefinition: true)
!129 = !DIGlobalVariableExpression(var: !130)
!130 = distinct !DIGlobalVariable(name: "prolog", scope: !115, file: !122, line: 21, type: !117, isLocal: false, isDefinition: true)
!131 = !DIGlobalVariableExpression(var: !132)
!132 = distinct !DIGlobalVariable(name: "epilog", scope: !115, file: !122, line: 21, type: !117, isLocal: false, isDefinition: true)
!133 = !DIGlobalVariableExpression(var: !134)
!134 = distinct !DIGlobalVariable(name: "kernel", scope: !115, file: !122, line: 21, type: !117, isLocal: false, isDefinition: true)
!135 = !DIGlobalVariableExpression(var: !136)
!136 = distinct !DIGlobalVariable(name: "ArrPtr", scope: !115, file: !122, line: 22, type: !117, isLocal: false, isDefinition: true)
!137 = !DIGlobalVariableExpression(var: !138)
!138 = distinct !DIGlobalVariable(name: "prologPtr", scope: !115, file: !122, line: 24, type: !16, isLocal: false, isDefinition: true)
!139 = !DIGlobalVariableExpression(var: !140)
!140 = distinct !DIGlobalVariable(name: "kernelPtr", scope: !115, file: !122, line: 24, type: !16, isLocal: false, isDefinition: true)
!141 = !DIGlobalVariableExpression(var: !142)
!142 = distinct !DIGlobalVariable(name: "epilogPtr", scope: !115, file: !122, line: 24, type: !16, isLocal: false, isDefinition: true)
!143 = !DIGlobalVariableExpression(var: !144)
!144 = distinct !DIGlobalVariable(name: "initCGRA", scope: !115, file: !122, line: 26, type: !145, isLocal: false, isDefinition: true)
!145 = !DICompositeType(tag: DW_TAG_array_type, baseType: !17, size: 224, elements: !66)
!146 = !DIGlobalVariableExpression(var: !147)
!147 = distinct !DIGlobalVariable(name: "pth", scope: !115, file: !122, line: 28, type: !148, isLocal: false, isDefinition: true)
!148 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !149, line: 37, baseType: !150)
!149 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount8")
!150 = !DIBasicType(name: "long unsigned int", size: 32, encoding: DW_ATE_unsigned)
!151 = !{!152}
!152 = !DILocalVariable(name: "arg", arg: 1, scope: !112, file: !111, line: 194, type: !60)
!153 = !{i32 5262}
!154 = !{i32 6297}
!155 = distinct !{!155, !156}
!156 = !DILocation(line: 234, column: 5, scope: !112)
!157 = distinct !{!157, !158}
!158 = !DILocation(line: 254, column: 41, scope: !159)
!159 = distinct !DISubprogram(name: "accelerateOnCGRA", scope: !111, file: !111, line: 238, type: !160, isLocal: false, isDefinition: true, scopeLine: 239, flags: DIFlagPrototyped, isOptimized: true, unit: !115, variables: !162)
!160 = !DISubroutineType(types: !161)
!161 = !{null, !118}
!162 = !{!163, !164, !165}
!163 = !DILocalVariable(name: "loopNo", arg: 1, scope: !159, file: !111, line: 238, type: !118)
!164 = !DILocalVariable(name: "result", scope: !159, file: !111, line: 240, type: !17)
!165 = !DILocalVariable(name: "configure", scope: !159, file: !111, line: 243, type: !17)
