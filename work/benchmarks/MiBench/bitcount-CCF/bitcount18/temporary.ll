...
; <label>:7:                                      ; preds = %2
  ...
  br i1 %12, label %.preheader2.preheader, label %72
...
.preheader2:                                      ; preds = %.loopexit, %.preheader2.preheader
  ...
  br i1 %19, label %.preheader.preheader, label %61

.preheader.preheader:                             ; preds = %.preheader2
  br label %.preheader

; <label>:21:                                     ; preds = %61, %21
  %22 = phi i32 [ %20, %61 ], [ %28, %21 ]
  %23 = phi i32 [ 0, %61 ], [ %26, %21 ]
  %24 = phi i32 [ 0, %61 ], [ %27, %21 ]
  %25 = tail call i32 %63(i32 %22) #5
  %26 = add nsw i32 %25, %23
  %27 = add nuw nsw i32 %24, 1
  %28 = add nsw i32 %22, 13
  %29 = icmp eq i32 %27, %10
  br i1 %29, label %.loopexit.loopexit23, label %21, !llvm.loop !35

.loopexit.loopexit:                               ; preds = %bit_count.exit
  br label %.loopexit

.loopexit.loopexit23:                             ; preds = %21
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit23, %.loopexit.loopexit
  %30 = phi i32 [ %57, %.loopexit.loopexit ], [ %26, %.loopexit.loopexit23 ]
...
.preheader:                                       ; preds = %bit_count.exit, %.preheader.preheader
  %46 = phi i32 [ %59, %bit_count.exit ], [ %20, %.preheader.preheader ]
  %47 = phi i32 [ %57, %bit_count.exit ], [ 0, %.preheader.preheader ]
  %48 = phi i32 [ %58, %bit_count.exit ], [ 0, %.preheader.preheader ]
  %49 = icmp eq i32 %46, 0
  br i1 %49, label %bit_count.exit, label %.preheader.i.preheader, !llvm.loop !85

.preheader.i.preheader:                           ; preds = %.preheader
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.i, %.preheader.i.preheader
  %50 = phi i32 [ %54, %.preheader.i ], [ %46, %.preheader.i.preheader ]
  %51 = phi i32 [ %52, %.preheader.i ], [ 0, %.preheader.i.preheader ]
  %52 = add nuw nsw i32 %51, 1
  %53 = add nsw i32 %50, -1
  %54 = and i32 %53, %50
  %55 = icmp eq i32 %54, 0
  br i1 %55, label %bit_count.exit.loopexit, label %.preheader.i, !llvm.loop !85

bit_count.exit.loopexit:                          ; preds = %.preheader.i
  br label %bit_count.exit

bit_count.exit:                                   ; preds = %bit_count.exit.loopexit, %.preheader
  %56 = phi i32 [ 0, %.preheader ], [ %52, %bit_count.exit.loopexit ]
  %57 = add nsw i32 %56, %47
  %58 = add nuw nsw i32 %48, 1
  %59 = add nsw i32 %46, 13
  %60 = icmp eq i32 %58, %10
  br i1 %60, label %.loopexit.loopexit, label %.preheader, !llvm.loop !94

; <label>:61:                                     ; preds = %.preheader2
  %62 = getelementptr inbounds [7 x i32 (i32)*], [7 x i32 (i32)*]* @main.pBitCntFunc, i32 0, i32 %16
  %63 = load i32 (i32)*, i32 (i32)** %62, align 4, !tbaa !34
  br label %21

.loopexit3.loopexit:                              ; preds = %.loopexit
  br label %.loopexit3

.loopexit3:                                       ; preds = %72, %.loopexit3.loopexit
  %64 = phi i32 [ %156, %72 ], [ %36, %.loopexit3.loopexit ]
  %65 = phi i32 [ %158, %72 ], [ %40, %.loopexit3.loopexit ]
  %66 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %64
  %67 = load i8*, i8** %66, align 4, !tbaa !34
  %68 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.10, i32 0, i32 0), i8* %67)
  %69 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %65
  %70 = load i8*, i8** %69, align 4, !tbaa !34
  %71 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* %70)
  ret i32 0

; <label>:72:                                     ; preds = %7
  %73 = tail call i32 @clock() #5
  %74 = tail call i32 @rand() #5
  %75 = tail call i32 @clock() #5
  %76 = sub nsw i32 %75, %73
  %77 = sitofp i32 %76 to double
  %78 = fdiv double %77, 1.000000e+06
  %79 = fcmp olt double %78, 0x7FEFFFFFFFFFFFFF
  %80 = select i1 %79, double %78, double 0x7FEFFFFFFFFFFFFF
  %81 = fcmp ogt double %78, 0.000000e+00
  %82 = select i1 %81, double %78, double 0.000000e+00
  %83 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0), double %78, i32 0)
  %84 = tail call i32 @clock() #5
  %85 = tail call i32 @rand() #5
  %86 = tail call i32 @clock() #5
  %87 = sub nsw i32 %86, %84
  %88 = sitofp i32 %87 to double
  %89 = fdiv double %88, 1.000000e+06
  %90 = fcmp olt double %89, %80
  %91 = zext i1 %90 to i32
  %92 = select i1 %90, double %89, double %80
  %93 = fcmp ogt double %89, %82
  %94 = select i1 %93, double %89, double %82
  %95 = zext i1 %93 to i32
  %96 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1.2, i32 0, i32 0), double %89, i32 0)
  ...
  %103 = fcmp olt double %102, %92
  %104 = select i1 %103, i32 2, i32 %91
  %105 = select i1 %103, double %102, double %92
  %106 = fcmp ogt double %102, %94
  %107 = select i1 %106, double %102, double %94
  %108 = select i1 %106, i32 2, i32 %95
  %109 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), double %102, i32 0)
  ...
  %117 = select i1 %116, i32 3, i32 %104
  %118 = select i1 %116, double %115, double %105
  %119 = fcmp ogt double %115, %107
  %120 = select i1 %119, double %115, double %107
  %121 = select i1 %119, i32 3, i32 %108
  %122 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i32 0, i32 0), double %115, i32 0)
  ...
  %130 = select i1 %129, i32 4, i32 %117
  %131 = select i1 %129, double %128, double %118
  %132 = fcmp ogt double %128, %120
  %133 = select i1 %132, double %128, double %120
  %134 = select i1 %132, i32 4, i32 %121
  %135 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %128, i32 0)
  ...
  %143 = select i1 %142, i32 5, i32 %130
  %144 = select i1 %142, double %141, double %131
  %145 = fcmp ogt double %141, %133
  %146 = select i1 %145, double %141, double %133
  %147 = select i1 %145, i32 5, i32 %134
  %148 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.5, i32 0, i32 0), double %141, i32 0)
  ...
  %156 = select i1 %155, i32 6, i32 %143
  %157 = fcmp ogt double %154, %146
  %158 = select i1 %157, i32 6, i32 %147
  %159 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), double %154, i32 0)
  br label %.loopexit3
}
...
!11 = !DIFile(filename: "bitstrng.c", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
...
!38 = !DIFile(filename: "bitcnts.c", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
...
!69 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/time.h", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
!70 = !DIDerivedType(tag: DW_TAG_typedef, name: "__clock_t", file: !71, line: 135, baseType: !16)
!71 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/types.h", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
...
!88 = !DIFile(filename: "bitcnt_1.c", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
...
!94 = distinct !{!94, !95, !98}
!95 = !DILocation(line: 62, column: 27, scope: !96)
!96 = distinct !DILexicalBlock(scope: !97, file: !38, line: 61, column: 7)
!97 = distinct !DILexicalBlock(scope: !40, file: !38, line: 59, column: 5)
!98 = !{!"llvm.loop.CGRA.enable"}
!99 = distinct !{!99, !100}
...
!112 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.c", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
...
!123 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.h", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
...
!144 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/shail/Results-extra/MiBench/bitcount-ccf/bitcount18")
