...
.preheader1:                                      ; preds = %bit_count.exit, %.preheader1.preheader
  %101 = phi i32 [ %111, %bit_count.exit ], [ %14, %.preheader1.preheader ]
  %102 = phi i32 [ %109, %bit_count.exit ], [ 0, %.preheader1.preheader ]
  %103 = phi i32 [ %110, %bit_count.exit ], [ 0, %.preheader1.preheader ]
...
; <label>:105:                                    ; preds = %.preheader.i.preheader
  call void @accelerateOnCGRA(i32 1)
  br label %bit_count.exit.loopexit

bit_count.exit.loopexit:                          ; preds = %105
  br label %106

; <label>:106:                                    ; preds = %bit_count.exit.loopexit
  %107 = load i32, i32* @gVar2
  br label %bit_count.exit

bit_count.exit:                                   ; preds = %106, %.preheader1
  %108 = phi i32 [ 0, %.preheader1 ], [ %107, %106 ]
  %109 = add nsw i32 %108, %102
  %110 = add nuw nsw i32 %103, 1
  %111 = add nsw i32 %101, 13
  %112 = icmp eq i32 %110, %10
  br i1 %112, label %113, label %.preheader1, !llvm.loop !52

; <label>:113:                                    ; preds = %bit_count.exit
  %.lcssa8 = phi i32 [ %109, %bit_count.exit ]
  %114 = tail call i32 @clock() #5
  %115 = sub nsw i32 %114, %13
  %116 = sitofp i32 %115 to double
  %117 = fdiv double %116, 1.000000e+06
  %118 = fcmp olt double %117, 0x7FEFFFFFFFFFFFFF
  %119 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0), double %117, i32 %.lcssa8)
  %120 = tail call i32 @clock() #5
  %121 = tail call i32 @rand() #5
  %min.iters.check = icmp ult i32 %10, 4
  br i1 %min.iters.check, label %scalar.ph.preheader, label %min.iters.checked

scalar.ph.preheader:                              ; preds = %middle.block, %min.iters.checked, %113
  %.ph = phi i32 [ %121, %min.iters.checked ], [ %121, %113 ], [ %ind.end, %middle.block ]
  %.ph39 = phi i32 [ 0, %min.iters.checked ], [ 0, %113 ], [ %146, %middle.block ]
  %.ph40 = phi i32 [ 0, %min.iters.checked ], [ 0, %113 ], [ %n.vec, %middle.block ]
  br label %scalar.ph

min.iters.checked:                                ; preds = %113
  %n.mod.vf = and i32 %10, 3
  %n.vec = sub i32 %10, %n.mod.vf
  %cmp.zero = icmp eq i32 %n.vec, 0
  %122 = mul i32 %10, 13
  %123 = add i32 %121, %122
  %124 = mul nsw i32 %n.mod.vf, -13
  %ind.end = add i32 %123, %124
  br i1 %cmp.zero, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %min.iters.checked
  %.splatinsert = insertelement <4 x i32> undef, i32 %121, i32 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %144, %vector.body ]
  %125 = lshr <4 x i32> %vec.ind, <i32 1, i32 1, i32 1, i32 1>
  %126 = and <4 x i32> %125, <i32 1431655765, i32 1431655765, i32 1431655765, i32 1431655765>
  %127 = and <4 x i32> %vec.ind, <i32 1431655765, i32 1431655765, i32 1431655765, i32 1431655765>
  %128 = add nuw <4 x i32> %126, %127
  %129 = lshr <4 x i32> %128, <i32 2, i32 2, i32 2, i32 2>
  %130 = and <4 x i32> %129, <i32 858993459, i32 858993459, i32 858993459, i32 858993459>
  %131 = and <4 x i32> %128, <i32 858993459, i32 858993459, i32 858993459, i32 858993459>
  %132 = add nuw nsw <4 x i32> %130, %131
  %133 = lshr <4 x i32> %132, <i32 4, i32 4, i32 4, i32 4>
  %134 = and <4 x i32> %133, <i32 117901063, i32 117901063, i32 117901063, i32 117901063>
  %135 = and <4 x i32> %132, <i32 117901063, i32 117901063, i32 117901063, i32 117901063>
  %136 = add nuw nsw <4 x i32> %134, %135
  %137 = lshr <4 x i32> %136, <i32 8, i32 8, i32 8, i32 8>
  %138 = and <4 x i32> %137, <i32 983055, i32 983055, i32 983055, i32 983055>
  %139 = and <4 x i32> %136, <i32 983055, i32 983055, i32 983055, i32 983055>
  %140 = add nuw nsw <4 x i32> %138, %139
  %141 = lshr <4 x i32> %140, <i32 16, i32 16, i32 16, i32 16>
  %142 = and <4 x i32> %140, <i32 31, i32 31, i32 31, i32 31>
  %143 = add <4 x i32> %142, %vec.phi
  %144 = add <4 x i32> %143, %141
  %index.next = add i32 %index, 4
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 52, i32 52, i32 52, i32 52>
  %145 = icmp eq i32 %index.next, %n.vec
  br i1 %145, label %middle.block, label %vector.body, !llvm.loop !96

middle.block:                                     ; preds = %vector.body
  %.lcssa7 = phi <4 x i32> [ %144, %vector.body ]
  ...
  %146 = extractelement <4 x i32> %bin.rdx37, i32 0
  %cmp.n = icmp eq i32 %n.mod.vf, 0
  br i1 %cmp.n, label %.loopexit38, label %scalar.ph.preheader

; <label>:147:                                    ; preds = %389, %15
  %148 = phi i32 [ %400, %389 ], [ %97, %15 ]
  %149 = phi i32 [ %402, %389 ], [ %99, %15 ]
  %150 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %148
  %151 = load i8*, i8** %150, align 4, !tbaa !34
  %152 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.10, i32 0, i32 0), i8* %151)
  %153 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %149
  %154 = load i8*, i8** %153, align 4, !tbaa !34
  %155 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* %154)
  ret i32 0

scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  %156 = phi i32 [ %180, %scalar.ph ], [ %.ph, %scalar.ph.preheader ]
  %157 = phi i32 [ %178, %scalar.ph ], [ %.ph39, %scalar.ph.preheader ]
  %158 = phi i32 [ %179, %scalar.ph ], [ %.ph40, %scalar.ph.preheader ]
  %159 = lshr i32 %156, 1
  %160 = and i32 %159, 1431655765
  %161 = and i32 %156, 1431655765
  %162 = add nuw i32 %160, %161
  %163 = lshr i32 %162, 2
  %164 = and i32 %163, 858993459
  %165 = and i32 %162, 858993459
  %166 = add nuw nsw i32 %164, %165
  %167 = lshr i32 %166, 4
  %168 = and i32 %167, 117901063
  %169 = and i32 %166, 117901063
  %170 = add nuw nsw i32 %168, %169
  %171 = lshr i32 %170, 8
  %172 = and i32 %171, 983055
  %173 = and i32 %170, 983055
  ...
  %180 = add nsw i32 %156, 13
  %181 = icmp eq i32 %179, %10
  br i1 %181, label %.loopexit38.loopexit, label %scalar.ph, !llvm.loop !99

.loopexit38.loopexit:                             ; preds = %scalar.ph
  %.lcssa6 = phi i32 [ %178, %scalar.ph ]
  br label %.loopexit38

.loopexit38:                                      ; preds = %.loopexit38.loopexit, %middle.block
  %.lcssa31 = phi i32 [ %146, %middle.block ], [ %.lcssa6, %.loopexit38.loopexit ]
  %182 = fcmp ogt double %117, 0.000000e+00
  %183 = select i1 %118, double %117, double 0x7FEFFFFFFFFFFFFF
  %184 = select i1 %182, double %117, double 0.000000e+00
  %185 = tail call i32 @clock() #5
  %186 = sub nsw i32 %185, %120
  %187 = sitofp i32 %186 to double
  %188 = fdiv double %187, 1.000000e+06
  %189 = fcmp olt double %188, %183
  %190 = fcmp ogt double %188, %184
  %191 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1.2, i32 0, i32 0), double %188, i32 %.lcssa31)
  %192 = tail call i32 @clock() #5
  %193 = tail call i32 @rand() #5
  br label %194

; <label>:194:                                    ; preds = %194, %.loopexit38
  %195 = phi i32 [ %193, %.loopexit38 ], [ %201, %194 ]
  %196 = phi i32 [ 0, %.loopexit38 ], [ %199, %194 ]
  %197 = phi i32 [ 0, %.loopexit38 ], [ %200, %194 ]
  %198 = tail call i32 @ntbl_bitcnt(i32 %195) #5
  %199 = add nsw i32 %198, %196
  %200 = add nuw nsw i32 %197, 1
  %201 = add nsw i32 %195, 13
  %202 = icmp eq i32 %200, %10
  br i1 %202, label %203, label %194, !llvm.loop !52

; <label>:203:                                    ; preds = %194
  %.lcssa5 = phi i32 [ %199, %194 ]
  %204 = zext i1 %189 to i32
  %205 = select i1 %190, double %188, double %184
  %206 = select i1 %189, double %188, double %183
  %207 = tail call i32 @clock() #5
  %208 = sub nsw i32 %207, %192
  %209 = sitofp i32 %208 to double
  %210 = fdiv double %209, 1.000000e+06
  %211 = fcmp olt double %210, %206
  %212 = fcmp ogt double %210, %205
  %213 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), double %210, i32 %.lcssa5)
  %214 = tail call i32 @clock() #5
  %215 = tail call i32 @rand() #5
  br label %216

; <label>:216:                                    ; preds = %216, %203
  %217 = phi i32 [ %215, %203 ], [ %267, %216 ]
  %218 = phi i32 [ 0, %203 ], [ %265, %216 ]
  %219 = phi i32 [ 0, %203 ], [ %266, %216 ]
  %220 = and i32 %217, 15
  ...
  %254 = lshr i32 %217, 28
  %255 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %254
  ...
  %267 = add nsw i32 %217, 13
  %268 = icmp eq i32 %266, %10
  br i1 %268, label %269, label %216, !llvm.loop !52

; <label>:269:                                    ; preds = %216
  %.lcssa4 = phi i32 [ %265, %216 ]
  %270 = zext i1 %190 to i32
  %271 = select i1 %211, i32 2, i32 %204
  %272 = select i1 %212, double %210, double %205
  %273 = select i1 %211, double %210, double %206
  %274 = tail call i32 @clock() #5
  %275 = sub nsw i32 %274, %214
  %276 = sitofp i32 %275 to double
  %277 = fdiv double %276, 1.000000e+06
  %278 = fcmp olt double %277, %273
  %279 = fcmp ogt double %277, %272
  %280 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i32 0, i32 0), double %277, i32 %.lcssa4)
  %281 = tail call i32 @clock() #5
  %282 = tail call i32 @rand() #5
  br label %283

; <label>:283:                                    ; preds = %283, %269
  %284 = phi i32 [ %282, %269 ], [ %310, %283 ]
  %285 = phi i32 [ 0, %269 ], [ %308, %283 ]
  %286 = phi i32 [ 0, %269 ], [ %309, %283 ]
  %287 = lshr i32 %284, 8
  %288 = lshr i32 %284, 16
  %289 = lshr i32 %284, 24
  %290 = and i32 %284, 255
  %291 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %290
  %292 = load i8, i8* %291, align 1, !tbaa !5
  %293 = zext i8 %292 to i32
  %294 = and i32 %287, 255
  %295 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %294
  %296 = load i8, i8* %295, align 1, !tbaa !5
  %297 = zext i8 %296 to i32
  %298 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %289
  %299 = load i8, i8* %298, align 1, !tbaa !5
  %300 = zext i8 %299 to i32
  %301 = and i32 %288, 255
  %302 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %301
  ...
  %307 = add i32 %306, %300
  %308 = add i32 %307, %304
  %309 = add nuw nsw i32 %286, 1
  %310 = add nsw i32 %284, 13
  %311 = icmp eq i32 %309, %10
  br i1 %311, label %312, label %283, !llvm.loop !52

; <label>:312:                                    ; preds = %283
  %.lcssa3 = phi i32 [ %308, %283 ]
  %313 = select i1 %212, i32 2, i32 %270
  %314 = select i1 %278, i32 3, i32 %271
  %315 = select i1 %279, double %277, double %272
  %316 = select i1 %278, double %277, double %273
  %317 = tail call i32 @clock() #5
  %318 = sub nsw i32 %317, %281
  %319 = sitofp i32 %318 to double
  %320 = fdiv double %319, 1.000000e+06
  %321 = fcmp olt double %320, %316
  %322 = fcmp ogt double %320, %315
  %323 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %320, i32 %.lcssa3)
  %324 = tail call i32 @clock() #5
  %325 = tail call i32 @rand() #5
  br label %326

; <label>:326:                                    ; preds = %326, %312
  %327 = phi i32 [ %325, %312 ], [ %353, %326 ]
  %328 = phi i32 [ 0, %312 ], [ %351, %326 ]
  %329 = phi i32 [ 0, %312 ], [ %352, %326 ]
  %330 = lshr i32 %327, 8
  %331 = lshr i32 %327, 16
  %332 = lshr i32 %327, 24
  %333 = and i32 %327, 255
  %334 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %333
  %335 = load i8, i8* %334, align 1, !tbaa !5
  %336 = zext i8 %335 to i32
  %337 = and i32 %330, 255
  %338 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %337
  %339 = load i8, i8* %338, align 1, !tbaa !5
  %340 = zext i8 %339 to i32
  %341 = and i32 %331, 255
  %342 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %341
  %343 = load i8, i8* %342, align 1, !tbaa !5
  %344 = zext i8 %343 to i32
  %345 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %332
  ...
  %350 = add i32 %349, %344
  %351 = add i32 %350, %347
  %352 = add nuw nsw i32 %329, 1
  %353 = add nsw i32 %327, 13
  %354 = icmp eq i32 %352, %10
  br i1 %354, label %355, label %326, !llvm.loop !52

; <label>:355:                                    ; preds = %326
  %.lcssa2 = phi i32 [ %351, %326 ]
  %356 = select i1 %279, i32 3, i32 %313
  %357 = select i1 %321, i32 4, i32 %314
  %358 = select i1 %322, double %320, double %315
  %359 = select i1 %321, double %320, double %316
  %360 = tail call i32 @clock() #5
  %361 = sub nsw i32 %360, %324
  %362 = sitofp i32 %361 to double
  %363 = fdiv double %362, 1.000000e+06
  %364 = fcmp olt double %363, %359
  %365 = fcmp ogt double %363, %358
  %366 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.5, i32 0, i32 0), double %363, i32 %.lcssa2)
  %367 = tail call i32 @clock() #5
  %368 = tail call i32 @rand() #5
  br label %369

; <label>:369:                                    ; preds = %.loopexit, %355
  %370 = phi i32 [ %368, %355 ], [ %387, %.loopexit ]
  %371 = phi i32 [ 0, %355 ], [ %385, %.loopexit ]
  %372 = phi i32 [ 0, %355 ], [ %386, %.loopexit ]
  %373 = icmp eq i32 %370, 0
  br i1 %373, label %.loopexit, label %.preheader.preheader

.preheader.preheader:                             ; preds = %369
  br label %.preheader

.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  %374 = phi i32 [ %378, %.preheader ], [ 0, %.preheader.preheader ]
  %375 = phi i32 [ %379, %.preheader ], [ 0, %.preheader.preheader ]
  %376 = phi i32 [ %380, %.preheader ], [ %370, %.preheader.preheader ]
  %377 = and i32 %376, 1
  %378 = add nsw i32 %377, %374
  %379 = add nuw nsw i32 %375, 1
  %380 = ashr i32 %376, 1
  %381 = icmp ne i32 %380, 0
  %382 = icmp ult i32 %379, 32
  %383 = and i1 %382, %381
  br i1 %383, label %.preheader, label %.loopexit.loopexit, !llvm.loop !101

.loopexit.loopexit:                               ; preds = %.preheader
  %.lcssa = phi i32 [ %378, %.preheader ]
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %369
  %384 = phi i32 [ 0, %369 ], [ %.lcssa, %.loopexit.loopexit ]
  %385 = add nsw i32 %384, %371
  %386 = add nuw nsw i32 %372, 1
  %387 = add nsw i32 %370, 13
  %388 = icmp eq i32 %386, %10
  br i1 %388, label %389, label %369, !llvm.loop !52

; <label>:389:                                    ; preds = %.loopexit
  %.lcssa1 = phi i32 [ %385, %.loopexit ]
  %390 = select i1 %322, i32 4, i32 %356
  %391 = select i1 %364, i32 5, i32 %357
  %392 = select i1 %365, double %363, double %358
  %393 = select i1 %364, double %363, double %359
  %394 = select i1 %365, i32 5, i32 %390
  %395 = tail call i32 @clock() #5
  %396 = sub nsw i32 %395, %367
  %397 = sitofp i32 %396 to double
  %398 = fdiv double %397, 1.000000e+06
  %399 = fcmp olt double %398, %393
  %400 = select i1 %399, i32 6, i32 %391
  %401 = fcmp ogt double %398, %392
  %402 = select i1 %401, i32 6, i32 %394
  %403 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), double %398, i32 %.lcssa1)
  br label %147
}
...
; <label>:4:                                      ; preds = %.loopexit.loopexit
  %5 = load i32, i32* @gVar4
  br label %.loopexit
