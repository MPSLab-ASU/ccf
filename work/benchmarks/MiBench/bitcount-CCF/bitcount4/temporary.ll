...
.preheader:                                       ; preds = %32, %.preheader.preheader
  %20 = phi i32 [ %22, %32 ], [ %2, %.preheader.preheader ]
  %21 = phi i8* [ %33, %32 ], [ %15, %.preheader.preheader ]
  %22 = add nsw i32 %20, -1
  %23 = lshr i32 %1, %22
  %24 = and i32 %23, 1
  %25 = or i32 %24, 48
...
; <label>:32:                                     ; preds = %35, %.preheader
  %33 = phi i8* [ %36, %35 ], [ %27, %.preheader ]
  %34 = icmp sgt i32 %20, 1
  br i1 %34, label %.preheader, label %.loopexit.loopexit, !llvm.loop !8

; <label>:35:                                     ; preds = %.preheader
  %36 = getelementptr inbounds i8, i8* %21, i32 2
...
; <label>:37:                                     ; preds = %.loopexit.loopexit
  %38 = load i8*, i8** @gPtr2
  br label %.loopexit

.loopexit:                                        ; preds = %37, %14
  %39 = phi i8* [ %15, %14 ], [ %38, %37 ]
...
; <label>:6:                                      ; preds = %2
  ...
  store %struct._IO_FILE* %7, %struct._IO_FILE** %8, align 4, !tbaa !28
...
; <label>:11:                                     ; preds = %6
  ...
  store i8 0, i8* %12, align 1, !tbaa !31
  %13 = getelementptr inbounds i8, i8* %3, i32 7
  store i8 0, i8* %13, align 1, !tbaa !32
  br label %14
...
; <label>:9:                                      ; preds = %2
  %10 = load i8, i8* %6, align 2, !tbaa !34
  %11 = zext i8 %10 to i32
  %12 = getelementptr inbounds %struct.bfile, %struct.bfile* %1, i32 0, i32 0
  %13 = load %struct._IO_FILE*, %struct._IO_FILE** %12, align 4, !tbaa !28
...
; <label>:15:                                     ; preds = %9, %7
  %16 = phi i8 [ %8, %7 ], [ 1, %9 ]
  store i8 %16, i8* %3, align 1, !tbaa !32
  %17 = load i8, i8* %6, align 2, !tbaa !34
  %18 = zext i8 %17 to i32
  %19 = shl nuw nsw i32 %18, 1
  %20 = and i32 %0, 1
  %21 = or i32 %19, %20
  %22 = trunc i32 %21 to i8
  store i8 %22, i8* %6, align 2, !tbaa !34
  ret void
}
...
define void @bfclose(%struct.bfile* nocapture) local_unnamed_addr #2 {
  ...
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** %2, align 4, !tbaa !28
...
; <label>:4:                                      ; preds = %2
  %5 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 4, !tbaa !35
...
; <label>:7:                                      ; preds = %2
  ...
  %9 = load i8*, i8** %8, align 4, !tbaa !35
...
.preheader1:                                      ; preds = %bit_count.exit, %.preheader1.preheader
  ...
  br i1 %104, label %bit_count.exit, label %.preheader.i.preheader, !llvm.loop !36
...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader.i.preheader
  ...
  br i1 %110, label %bit_count.exit.loopexit, label %.preheader.i, !llvm.loop !36
...
bit_count.exit:                                   ; preds = %bit_count.exit.loopexit, %.preheader1
  ...
  br i1 %115, label %116, label %.preheader1, !llvm.loop !47
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %148, label %middle.block, label %vector.body, !llvm.loop !91
...
; <label>:150:                                    ; preds = %392, %15
  ...
  %154 = load i8*, i8** %153, align 4, !tbaa !35
  ...
  %157 = load i8*, i8** %156, align 4, !tbaa !35
...
scalar.ph:                                        ; preds = %scalar.ph, %scalar.ph.preheader
  ...
  br i1 %184, label %.loopexit38.loopexit, label %scalar.ph, !llvm.loop !94
...
; <label>:197:                                    ; preds = %197, %.loopexit38
  ...
  br i1 %205, label %206, label %197, !llvm.loop !47
...
; <label>:219:                                    ; preds = %219, %206
  ...
  br i1 %271, label %272, label %219, !llvm.loop !47
...
; <label>:286:                                    ; preds = %286, %272
  ...
  br i1 %314, label %315, label %286, !llvm.loop !47
...
; <label>:329:                                    ; preds = %329, %315
  ...
  br i1 %357, label %358, label %329, !llvm.loop !47
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %386 = and i1 %385, %384
  br i1 %386, label %.preheader, label %.loopexit.loopexit, !llvm.loop !96
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %372
  ...
  br i1 %391, label %392, label %372, !llvm.loop !47
...
define i32 @bit_count(i32) local_unnamed_addr #7 {
  %2 = icmp eq i32 %0, 0
  br i1 %2, label %.loopexit, label %.preheader.preheader, !llvm.loop !36
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %7 = and i32 %6, %3
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %.loopexit.loopexit, label %.preheader, !llvm.loop !36
...
define i32 @initializeParameters(i32) local_unnamed_addr #2 {
  ...
  %14 = load i32*, i32** @initCGRA, align 4, !tbaa !35
  %15 = add i32 %0, -1
  %16 = mul i32 %15, 7
  %17 = getelementptr inbounds i32, i32* %14, i32 %16
  store i32 2011168768, i32* %17, align 4, !tbaa !104
  %18 = getelementptr inbounds i32, i32* %17, i32 1
  store i32 2011168768, i32* %18, align 4, !tbaa !104
  ...
  store i8* %56, i8** bitcast (i32** @epilog to i8**), align 4, !tbaa !35
  %57 = shl i32 %50, 2
  %58 = call noalias i8* @malloc(i32 %57) #5
  store i8* %58, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !35
  %59 = shl i32 %52, 2
  %60 = call noalias i8* @malloc(i32 %59) #5
  store i8* %60, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !35
  %61 = call i32 @fread(i8* %56, i32 4, i32 %48, %struct._IO_FILE* %38)
  %62 = load i8*, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !35
  %63 = call i32 @fread(i8* %62, i32 4, i32 %50, %struct._IO_FILE* %39)
  %64 = load i8*, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !35
  ...
  %72 = sdiv i32 %48, 16
  %73 = sdiv i32 %50, 16
  %74 = load i32*, i32** @initCGRA, align 4, !tbaa !35
  %75 = getelementptr inbounds i32, i32* %74, i32 %16
  %76 = getelementptr inbounds i32, i32* %75, i32 2
  store i32 %71, i32* %76, align 4, !tbaa !104
  %77 = getelementptr inbounds i32, i32* %75, i32 3
  store i32 %72, i32* %77, align 4, !tbaa !104
  %78 = getelementptr inbounds i32, i32* %75, i32 4
  store i32 %73, i32* %78, align 4, !tbaa !104
  %79 = load i32, i32* %11, align 4, !tbaa !104
  %80 = sdiv i32 %79, 16
  %81 = getelementptr inbounds i32, i32* %75, i32 6
  store i32 %80, i32* %81, align 4, !tbaa !104
  ...
  store i32 0, i32* %13, align 4, !tbaa !104
  ...
  %94 = load i32, i32* %13, align 4, !tbaa !104
  %95 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i32 0, i32 0), i32 %94)
  %96 = load i32, i32* %13, align 4, !tbaa !104
  %97 = load i32*, i32** @initCGRA, align 4, !tbaa !35
  %98 = getelementptr inbounds i32, i32* %97, i32 %16
  %99 = getelementptr inbounds i32, i32* %98, i32 5
  store i32 %96, i32* %99, align 4, !tbaa !104
  %100 = load i32, i32* bitcast (i32** @prolog to i32*), align 4, !tbaa !35
  %101 = load i32, i32* bitcast (i32** @epilog to i32*), align 4, !tbaa !35
  %102 = load i32, i32* bitcast (i32** @kernel to i32*), align 4, !tbaa !35
  %103 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.13.25, i32 0, i32 0), i32 %100, i32 %101, i32 %102)
  %104 = load i32, i32* bitcast (i32** @prolog to i32*), align 4, !tbaa !35
  %105 = load i32*, i32** @prologPtr, align 4, !tbaa !35
  %106 = getelementptr inbounds i32, i32* %105, i32 %15
  store i32 %104, i32* %106, align 4, !tbaa !106
  %107 = load i32, i32* bitcast (i32** @epilog to i32*), align 4, !tbaa !35
  %108 = load i32*, i32** @epilogPtr, align 4, !tbaa !35
  %109 = getelementptr inbounds i32, i32* %108, i32 %15
  store i32 %107, i32* %109, align 4, !tbaa !106
  %110 = load i32, i32* bitcast (i32** @kernel to i32*), align 4, !tbaa !35
  %111 = load i32*, i32** @kernelPtr, align 4, !tbaa !35
  %112 = getelementptr inbounds i32, i32* %111, i32 %15
  store i32 %110, i32* %112, align 4, !tbaa !106
...
; <label>:16:                                     ; preds = %1
  %17 = load i32, i32* @dynamicTCVal, align 4, !tbaa !104
  %18 = add nsw i32 %17, %10
  %19 = load i32*, i32** @initCGRA, align 4, !tbaa !35
  %20 = getelementptr inbounds i32, i32* %19, i32 %7
  %21 = getelementptr inbounds i32, i32* %20, i32 5
  store i32 %18, i32* %21, align 4, !tbaa !104
  br label %22
...
; <label>:22:                                     ; preds = %16, %1
  ...
  %27 = load i32*, i32** @initCGRA, align 4, !tbaa !35
  %28 = getelementptr inbounds i32, i32* %27, i32 %7
  %29 = load i32, i32* %28, align 4, !tbaa !104
  ...
  %31 = load i32*, i32** @initCGRA, align 4, !tbaa !35
  %32 = getelementptr inbounds i32, i32* %31, i32 %7
  %33 = getelementptr inbounds i32, i32* %32, i32 1
  %34 = load i32, i32* %33, align 4, !tbaa !104
  ...
  %61 = load i32*, i32** @epilogPtr, align 4, !tbaa !35
  %62 = getelementptr inbounds i32, i32* %61, i32 %6
  %63 = load i32, i32* %62, align 4, !tbaa !106
  ...
  %65 = load i32*, i32** @prologPtr, align 4, !tbaa !35
  %66 = getelementptr inbounds i32, i32* %65, i32 %6
  %67 = load i32, i32* %66, align 4, !tbaa !106
  ...
  %69 = load i32*, i32** @kernelPtr, align 4, !tbaa !35
  %70 = getelementptr inbounds i32, i32* %69, i32 %6
  %71 = load i32, i32* %70, align 4, !tbaa !106
...
define void @updateLoopTC(i32) local_unnamed_addr #10 {
  %2 = load i32*, i32** @initCGRA, align 4, !tbaa !35
...
; <label>:6:                                      ; preds = %1
  %7 = load i32, i32* @dynamicTCVal, align 4, !tbaa !104
  store i32 %7, i32* %3, align 4, !tbaa !104
  br label %8
...
; <label>:2:                                      ; preds = %11, %1
  %3 = load i32, i32* @thread_cond_cgra, align 4, !tbaa !104
  %4 = icmp eq i32 %3, 1
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %6 = load i32, i32* @thread_cond_cgra, align 4, !tbaa !104
  %7 = icmp eq i32 %6, 1
  br i1 %7, label %.loopexit.loopexit, label %.preheader, !llvm.loop !108

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %2
  %8 = load i32, i32* @thread_exit, align 4, !tbaa !104
  %9 = icmp eq i32 %8, 1
  br i1 %9, label %10, label %11
...
; <label>:11:                                     ; preds = %.loopexit
  store i32 0, i32* @thread_cond_cgra, align 4, !tbaa !104
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #5, !srcloc !157
  %12 = tail call i32 @usleep(i32 1) #5
  store i32 1, i32* @thread_cond_cpu, align 4, !tbaa !104
...
define void @accelerateOnCGRA(i32) local_unnamed_addr #2 {
  ...
  store i32 0, i32* @thread_cond_cpu, align 4, !tbaa !104
  store i32 1, i32* @thread_cond_cgra, align 4, !tbaa !104
  br label %4

; <label>:4:                                      ; preds = %4, %1
  %5 = tail call i32 @usleep(i32 1) #5
  %6 = load i32, i32* @thread_cond_cpu, align 4, !tbaa !104
  %7 = icmp eq i32 %6, 1
...
define void @createCGRA() local_unnamed_addr #2 {
  ...
  call void @llvm.lifetime.end(i64 40, i8* nonnull %2) #5
  %6 = load i32, i32* @totalLoops, align 4, !tbaa !104
  %7 = mul i32 %6, 28
  %8 = tail call noalias i8* @malloc(i32 %7) #5
  store i8* %8, i8** bitcast (i32** @initCGRA to i8**), align 4, !tbaa !35
  %9 = shl i32 %6, 2
  %10 = tail call noalias i8* @malloc(i32 %9) #5
  store i8* %10, i8** bitcast (i32** @prologPtr to i8**), align 4, !tbaa !35
  %11 = tail call noalias i8* @malloc(i32 %9) #5
  store i8* %11, i8** bitcast (i32** @kernelPtr to i8**), align 4, !tbaa !35
  %12 = tail call noalias i8* @malloc(i32 %9) #5
  store i8* %12, i8** bitcast (i32** @epilogPtr to i8**), align 4, !tbaa !35
  %13 = icmp eq i32 %6, 0
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %16 = add i32 %14, 1
  %17 = load i32, i32* @totalLoops, align 4, !tbaa !104
  %18 = icmp ugt i32 %16, %17
  br i1 %18, label %.loopexit.loopexit, label %.preheader, !llvm.loop !169
...
!7 = !{!"Simple C/C++ TBAA"}
!8 = distinct !{!8, !9, !27}
!9 = !DILocation(line: 44, column: 7, scope: !10)
...
!11 = !DIFile(filename: "bitstrng.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
...
!27 = !{!"llvm.loop.CGRA.enable"}
!28 = !{!29, !30, i64 0}
!29 = !{!"", !30, i64 0, !6, i64 4, !6, i64 5, !6, i64 6, !6, i64 7}
...
!35 = !{!30, !30, i64 0}
!36 = distinct !{!36, !37}
!37 = !DILocation(line: 18, column: 34, scope: !38)
!38 = distinct !DILexicalBlock(scope: !40, file: !39, line: 16, column: 13)
!39 = !DIFile(filename: "bitcnt_1.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!40 = distinct !DISubprogram(name: "bit_count", scope: !39, file: !39, line: 9, type: !41, isLocal: false, isDefinition: true, scopeLine: 10, flags: DIFlagPrototyped, isOptimized: true, unit: !43, variables: !44)
!41 = !DISubroutineType(types: !42)
!42 = !{!17, !16}
!43 = distinct !DICompileUnit(language: DW_LANG_C99, file: !39, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19)
!44 = !{!45, !46}
!45 = !DILocalVariable(name: "x", arg: 1, scope: !40, file: !39, line: 9, type: !16)
!46 = !DILocalVariable(name: "n", scope: !40, file: !39, line: 11, type: !17)
!47 = distinct !{!47, !48}
!48 = !DILocation(line: 60, column: 27, scope: !49)
!49 = distinct !DILexicalBlock(scope: !51, file: !50, line: 59, column: 5)
!50 = !DIFile(filename: "bitcnts.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!51 = distinct !DILexicalBlock(scope: !52, file: !50, line: 56, column: 31)
!52 = distinct !DILexicalBlock(scope: !53, file: !50, line: 56, column: 3)
!53 = distinct !DILexicalBlock(scope: !54, file: !50, line: 56, column: 3)
!54 = distinct !DISubprogram(name: "main", scope: !50, file: !50, line: 21, type: !55, isLocal: false, isDefinition: true, scopeLine: 22, flags: DIFlagPrototyped, isOptimized: true, unit: !58, variables: !72)
!55 = !DISubroutineType(types: !56)
!56 = !{!17, !17, !57}
!57 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !14, size: 32)
!58 = distinct !DICompileUnit(language: DW_LANG_C99, file: !50, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19, retainedTypes: !59, globals: !62)
!59 = !{!60, !17, !57, !61}
...
!64 = distinct !DIGlobalVariable(name: "pBitCntFunc", scope: !54, file: !50, line: 28, type: !65, isLocal: true, isDefinition: true)
!65 = !DICompositeType(tag: DW_TAG_array_type, baseType: !66, size: 224, elements: !67)
!66 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !41, size: 32)
!67 = !{!68}
!68 = !DISubrange(count: 7)
!69 = !DIGlobalVariableExpression(var: !70)
!70 = distinct !DIGlobalVariable(name: "text", scope: !54, file: !50, line: 38, type: !71, isLocal: true, isDefinition: true)
!71 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 224, elements: !67)
!72 = !{!73, !74, !75, !80, !81, !82, !83, !84, !85, !86, !87, !88, !89, !90}
!73 = !DILocalVariable(name: "argc", arg: 1, scope: !54, file: !50, line: 21, type: !17)
!74 = !DILocalVariable(name: "argv", arg: 2, scope: !54, file: !50, line: 21, type: !57)
!75 = !DILocalVariable(name: "start", scope: !54, file: !50, line: 23, type: !76)
!76 = !DIDerivedType(tag: DW_TAG_typedef, name: "clock_t", file: !77, line: 59, baseType: !78)
!77 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/time.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!78 = !DIDerivedType(tag: DW_TAG_typedef, name: "__clock_t", file: !79, line: 135, baseType: !16)
!79 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/types.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!80 = !DILocalVariable(name: "stop", scope: !54, file: !50, line: 23, type: !76)
!81 = !DILocalVariable(name: "ct", scope: !54, file: !50, line: 24, type: !60)
!82 = !DILocalVariable(name: "cmin", scope: !54, file: !50, line: 24, type: !60)
!83 = !DILocalVariable(name: "cmax", scope: !54, file: !50, line: 24, type: !60)
!84 = !DILocalVariable(name: "i", scope: !54, file: !50, line: 25, type: !17)
!85 = !DILocalVariable(name: "cminix", scope: !54, file: !50, line: 25, type: !17)
!86 = !DILocalVariable(name: "cmaxix", scope: !54, file: !50, line: 25, type: !17)
!87 = !DILocalVariable(name: "j", scope: !54, file: !50, line: 26, type: !16)
!88 = !DILocalVariable(name: "n", scope: !54, file: !50, line: 26, type: !16)
!89 = !DILocalVariable(name: "seed", scope: !54, file: !50, line: 26, type: !16)
!90 = !DILocalVariable(name: "iterations", scope: !54, file: !50, line: 27, type: !17)
!91 = distinct !{!91, !48, !92, !93}
!92 = !{!"llvm.loop.vectorize.width", i32 1}
!93 = !{!"llvm.loop.interleave.count", i32 1}
!94 = distinct !{!94, !48, !95, !92, !93}
!95 = !{!"llvm.loop.unroll.runtime.disable"}
!96 = distinct !{!96, !97}
!97 = !DILocation(line: 85, column: 22, scope: !98)
!98 = distinct !DILexicalBlock(scope: !99, file: !50, line: 84, column: 3)
!99 = distinct !DISubprogram(name: "bit_shifter", scope: !50, file: !50, line: 80, type: !41, isLocal: true, isDefinition: true, scopeLine: 81, flags: DIFlagPrototyped, isOptimized: true, unit: !58, variables: !100)
!100 = !{!101, !102, !103}
!101 = !DILocalVariable(name: "x", arg: 1, scope: !99, file: !50, line: 80, type: !16)
!102 = !DILocalVariable(name: "i", scope: !99, file: !50, line: 82, type: !17)
!103 = !DILocalVariable(name: "n", scope: !99, file: !50, line: 82, type: !17)
!104 = !{!105, !105, i64 0}
!105 = !{!"int", !6, i64 0}
!106 = !{!107, !107, i64 0}
!107 = !{!"long", !6, i64 0}
!108 = distinct !{!108, !109}
!109 = !DILocation(line: 223, column: 46, scope: !110)
!110 = distinct !DILexicalBlock(scope: !112, file: !111, line: 220, column: 14)
!111 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.c", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!112 = distinct !DISubprogram(name: "runOnCGRA", scope: !111, file: !111, line: 217, type: !113, isLocal: false, isDefinition: true, scopeLine: 218, flags: DIFlagPrototyped, isOptimized: true, unit: !115, variables: !154)
!113 = !DISubroutineType(types: !114)
!114 = !{!61, !61}
!115 = distinct !DICompileUnit(language: DW_LANG_C99, file: !111, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19, retainedTypes: !116, globals: !120)
!116 = !{!117, !118, !16, !61, !119}
...
!119 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !17, size: 32)
!120 = !{!121, !124, !126, !128, !130, !132, !134, !136, !138, !140, !143, !145, !147, !149}
!121 = !DIGlobalVariableExpression(var: !122)
!122 = distinct !DIGlobalVariable(name: "totalLoops", scope: !115, file: !123, line: 27, type: !118, isLocal: false, isDefinition: true)
!123 = !DIFile(filename: "/home/shail/CGRA/scripts/CGRALib/cgra.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!124 = !DIGlobalVariableExpression(var: !125)
!125 = distinct !DIGlobalVariable(name: "thread_cond_cpu", scope: !115, file: !123, line: 30, type: !118, isLocal: false, isDefinition: true)
!126 = !DIGlobalVariableExpression(var: !127)
!127 = distinct !DIGlobalVariable(name: "thread_cond_cgra", scope: !115, file: !123, line: 31, type: !118, isLocal: false, isDefinition: true)
!128 = !DIGlobalVariableExpression(var: !129)
!129 = distinct !DIGlobalVariable(name: "thread_exit", scope: !115, file: !123, line: 32, type: !118, isLocal: false, isDefinition: true)
!130 = !DIGlobalVariableExpression(var: !131)
!131 = distinct !DIGlobalVariable(name: "dynamicTCVal", scope: !115, file: !123, line: 34, type: !17, isLocal: false, isDefinition: true)
!132 = !DIGlobalVariableExpression(var: !133)
!133 = distinct !DIGlobalVariable(name: "prolog", scope: !115, file: !123, line: 21, type: !117, isLocal: false, isDefinition: true)
!134 = !DIGlobalVariableExpression(var: !135)
!135 = distinct !DIGlobalVariable(name: "epilog", scope: !115, file: !123, line: 21, type: !117, isLocal: false, isDefinition: true)
!136 = !DIGlobalVariableExpression(var: !137)
!137 = distinct !DIGlobalVariable(name: "kernel", scope: !115, file: !123, line: 21, type: !117, isLocal: false, isDefinition: true)
!138 = !DIGlobalVariableExpression(var: !139)
!139 = distinct !DIGlobalVariable(name: "ArrPtr", scope: !115, file: !123, line: 22, type: !117, isLocal: false, isDefinition: true)
!140 = !DIGlobalVariableExpression(var: !141)
!141 = distinct !DIGlobalVariable(name: "prologPtr", scope: !115, file: !123, line: 24, type: !142, isLocal: false, isDefinition: true)
!142 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !16, size: 32)
!143 = !DIGlobalVariableExpression(var: !144)
!144 = distinct !DIGlobalVariable(name: "kernelPtr", scope: !115, file: !123, line: 24, type: !142, isLocal: false, isDefinition: true)
!145 = !DIGlobalVariableExpression(var: !146)
!146 = distinct !DIGlobalVariable(name: "epilogPtr", scope: !115, file: !123, line: 24, type: !142, isLocal: false, isDefinition: true)
!147 = !DIGlobalVariableExpression(var: !148)
!148 = distinct !DIGlobalVariable(name: "initCGRA", scope: !115, file: !123, line: 26, type: !119, isLocal: false, isDefinition: true)
!149 = !DIGlobalVariableExpression(var: !150)
!150 = distinct !DIGlobalVariable(name: "pth", scope: !115, file: !123, line: 29, type: !151, isLocal: false, isDefinition: true)
!151 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !152, line: 37, baseType: !153)
!152 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/shail/Results-extra/MiBench/bitcount-CCF/bitcount4")
!153 = !DIBasicType(name: "long unsigned int", size: 32, encoding: DW_ATE_unsigned)
!154 = !{!155}
!155 = !DILocalVariable(name: "arg", arg: 1, scope: !112, file: !111, line: 217, type: !61)
!156 = !{i32 6148}
!157 = !{i32 7183}
!158 = distinct !{!158, !159}
!159 = !DILocation(line: 257, column: 5, scope: !112)
!160 = distinct !{!160, !161}
!161 = !DILocation(line: 277, column: 41, scope: !162)
!162 = distinct !DISubprogram(name: "accelerateOnCGRA", scope: !111, file: !111, line: 261, type: !163, isLocal: false, isDefinition: true, scopeLine: 262, flags: DIFlagPrototyped, isOptimized: true, unit: !115, variables: !165)
!163 = !DISubroutineType(types: !164)
!164 = !{null, !118}
!165 = !{!166, !167, !168}
!166 = !DILocalVariable(name: "loopNo", arg: 1, scope: !162, file: !111, line: 261, type: !118)
!167 = !DILocalVariable(name: "result", scope: !162, file: !111, line: 263, type: !17)
!168 = !DILocalVariable(name: "configure", scope: !162, file: !111, line: 266, type: !17)
!169 = distinct !{!169, !170}
!170 = !DILocation(line: 314, column: 29, scope: !171)
!171 = distinct !DILexicalBlock(scope: !172, file: !111, line: 313, column: 3)
!172 = distinct !DISubprogram(name: "createCGRA", scope: !111, file: !111, line: 293, type: !173, isLocal: false, isDefinition: true, scopeLine: 294, isOptimized: true, unit: !115, variables: !175)
!173 = !DISubroutineType(types: !174)
!174 = !{null}
!175 = !{!176, !177}
!176 = !DILocalVariable(name: "result", scope: !172, file: !111, line: 303, type: !17)
!177 = !DILocalVariable(name: "i", scope: !172, file: !111, line: 304, type: !118)
