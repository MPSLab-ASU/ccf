...
; <label>:4:                                      ; preds = %2
  ...
  %6 = tail call i32 @fwrite(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.7, i32 0, i32 0), i32 28, i32 1, %struct._IO_FILE* %5) #10
...
; <label>:7:                                      ; preds = %2
  ...
  br i1 %12, label %.preheader2.preheader, label %85
...
.preheader2:                                      ; preds = %.preheader2.preheader, %.loopexit
  ...
  br i1 %19, label %.preheader.preheader, label %74

.preheader.preheader:                             ; preds = %.preheader2
  br label %.preheader

; <label>:21:                                     ; preds = %74, %21
  %22 = phi i32 [ %20, %74 ], [ %28, %21 ]
  %23 = phi i32 [ 0, %74 ], [ %26, %21 ]
  %24 = phi i32 [ 0, %74 ], [ %27, %21 ]
  %25 = tail call i32 %76(i32 %22) #5
...
.loopexit:                                        ; preds = %.loopexit.loopexit19, %.loopexit.loopexit
  %30 = phi i32 [ %70, %.loopexit.loopexit ], [ %26, %.loopexit.loopexit19 ]
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %46 = phi i32 [ %72, %.preheader ], [ %20, %.preheader.preheader ]
  %47 = phi i32 [ %70, %.preheader ], [ 0, %.preheader.preheader ]
  %48 = phi i32 [ %71, %.preheader ], [ 0, %.preheader.preheader ]
  %49 = lshr i32 %46, 8
  %50 = lshr i32 %46, 16
  %51 = lshr i32 %46, 24
  %52 = and i32 %46, 255
  ...
  %64 = getelementptr inbounds [256 x i8], [256 x i8]* @bits, i32 0, i32 %51
  ...
  %72 = add nsw i32 %46, 13
  %73 = icmp eq i32 %71, %10
  br i1 %73, label %.loopexit.loopexit, label %.preheader, !llvm.loop !85

; <label>:74:                                     ; preds = %.preheader2
  %75 = getelementptr inbounds [7 x i32 (i32)*], [7 x i32 (i32)*]* @main.pBitCntFunc, i32 0, i32 %16
  %76 = load i32 (i32)*, i32 (i32)** %75, align 4, !tbaa !34
  br label %21

.loopexit3.loopexit:                              ; preds = %.loopexit
  br label %.loopexit3

.loopexit3:                                       ; preds = %.loopexit3.loopexit, %85
  %77 = phi i32 [ %169, %85 ], [ %36, %.loopexit3.loopexit ]
  %78 = phi i32 [ %171, %85 ], [ %40, %.loopexit3.loopexit ]
  %79 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %77
  %80 = load i8*, i8** %79, align 4, !tbaa !34
  %81 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.10, i32 0, i32 0), i8* %80)
  %82 = getelementptr inbounds [7 x i8*], [7 x i8*]* @main.text, i32 0, i32 %78
  %83 = load i8*, i8** %82, align 4, !tbaa !34
  %84 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* %83)
  ret i32 0

; <label>:85:                                     ; preds = %7
  %86 = tail call i32 @clock() #5
  %87 = tail call i32 @rand() #5
  %88 = tail call i32 @clock() #5
  %89 = sub nsw i32 %88, %86
  %90 = sitofp i32 %89 to double
  %91 = fdiv double %90, 1.000000e+06
  %92 = fcmp olt double %91, 0x7FEFFFFFFFFFFFFF
  %93 = select i1 %92, double %91, double 0x7FEFFFFFFFFFFFFF
  %94 = fcmp ogt double %91, 0.000000e+00
  %95 = select i1 %94, double %91, double 0.000000e+00
  %96 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.1, i32 0, i32 0), double %91, i32 0)
  %97 = tail call i32 @clock() #5
  %98 = tail call i32 @rand() #5
  %99 = tail call i32 @clock() #5
  %100 = sub nsw i32 %99, %97
  %101 = sitofp i32 %100 to double
  %102 = fdiv double %101, 1.000000e+06
  %103 = fcmp olt double %102, %93
  %104 = zext i1 %103 to i32
  %105 = select i1 %103, double %102, double %93
  %106 = fcmp ogt double %102, %95
  %107 = select i1 %106, double %102, double %95
  %108 = zext i1 %106 to i32
  %109 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1.2, i32 0, i32 0), double %102, i32 0)
  ...
  %117 = select i1 %116, i32 2, i32 %104
  %118 = select i1 %116, double %115, double %105
  %119 = fcmp ogt double %115, %107
  %120 = select i1 %119, double %115, double %107
  %121 = select i1 %119, i32 2, i32 %108
  %122 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), double %115, i32 0)
  ...
  %130 = select i1 %129, i32 3, i32 %117
  %131 = select i1 %129, double %128, double %118
  %132 = fcmp ogt double %128, %120
  %133 = select i1 %132, double %128, double %120
  %134 = select i1 %132, i32 3, i32 %121
  %135 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i32 0, i32 0), double %128, i32 0)
  %136 = tail call i32 @clock() #5
  %137 = tail call i32 @rand() #5
  %138 = tail call i32 @clock() #5
  %139 = sub nsw i32 %138, %136
  %140 = sitofp i32 %139 to double
  %141 = fdiv double %140, 1.000000e+06
  %142 = fcmp olt double %141, %131
  %143 = select i1 %142, i32 4, i32 %130
  %144 = select i1 %142, double %141, double %131
  %145 = fcmp ogt double %141, %133
  %146 = select i1 %145, double %141, double %133
  %147 = select i1 %145, i32 4, i32 %134
  %148 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), double %141, i32 0)
  %149 = tail call i32 @clock() #5
  %150 = tail call i32 @rand() #5
  %151 = tail call i32 @clock() #5
  %152 = sub nsw i32 %151, %149
  %153 = sitofp i32 %152 to double
  %154 = fdiv double %153, 1.000000e+06
  %155 = fcmp olt double %154, %144
  %156 = select i1 %155, i32 5, i32 %143
  %157 = select i1 %155, double %154, double %144
  %158 = fcmp ogt double %154, %146
  %159 = select i1 %158, double %154, double %146
  %160 = select i1 %158, i32 5, i32 %147
  %161 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.5, i32 0, i32 0), double %154, i32 0)
  %162 = tail call i32 @clock() #5
  %163 = tail call i32 @rand() #5
  %164 = tail call i32 @clock() #5
  %165 = sub nsw i32 %164, %162
  %166 = sitofp i32 %165 to double
  %167 = fdiv double %166, 1.000000e+06
  %168 = fcmp olt double %167, %157
  %169 = select i1 %168, i32 6, i32 %156
  %170 = fcmp ogt double %167, %159
  %171 = select i1 %170, i32 6, i32 %160
  %172 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), double %167, i32 0)
  br label %.loopexit3
}
...
!11 = !DIFile(filename: "bitstrng.c", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
...
!38 = !DIFile(filename: "bitcnts.c", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
...
!44 = distinct !DISubprogram(name: "main", scope: !38, file: !38, line: 21, type: !45, isLocal: false, isDefinition: true, scopeLine: 22, flags: DIFlagPrototyped, isOptimized: true, unit: !48, variables: !68)
!45 = !DISubroutineType(types: !46)
!46 = !{!17, !17, !47}
!47 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !14, size: 32)
!48 = distinct !DICompileUnit(language: DW_LANG_C99, file: !38, producer: "clang version 5.0.0 (trunk 296996) (llvm/trunk 296995)", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !19, retainedTypes: !49, globals: !56)
!49 = !{!50, !51, !17, !47, !55}
!50 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!51 = !DIDerivedType(tag: DW_TAG_typedef, name: "clock_t", file: !52, line: 59, baseType: !53)
!52 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/time.h", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
!53 = !DIDerivedType(tag: DW_TAG_typedef, name: "__clock_t", file: !54, line: 135, baseType: !16)
!54 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/types.h", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
!55 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 32)
!56 = !{!57, !65}
!57 = !DIGlobalVariableExpression(var: !58)
!58 = distinct !DIGlobalVariable(name: "pBitCntFunc", scope: !44, file: !38, line: 28, type: !59, isLocal: true, isDefinition: true)
!59 = !DICompositeType(tag: DW_TAG_array_type, baseType: !60, size: 224, elements: !63)
...
!66 = distinct !DIGlobalVariable(name: "text", scope: !44, file: !38, line: 38, type: !67, isLocal: true, isDefinition: true)
!67 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 224, elements: !63)
!68 = !{!69, !70, !71, !72, !73, !74, !75, !76, !77, !78, !79, !80, !81, !82}
!69 = !DILocalVariable(name: "argc", arg: 1, scope: !44, file: !38, line: 21, type: !17)
!70 = !DILocalVariable(name: "argv", arg: 2, scope: !44, file: !38, line: 21, type: !47)
!71 = !DILocalVariable(name: "start", scope: !44, file: !38, line: 23, type: !51)
!72 = !DILocalVariable(name: "stop", scope: !44, file: !38, line: 23, type: !51)
...
!93 = !DIFile(filename: "bitcnt_1.c", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
!94 = distinct !DISubprogram(name: "bit_count", scope: !93, file: !93, line: 9, type: !61, isLocal: false, isDefinition: true, scopeLine: 10, flags: DIFlagPrototyped, isOptimized: true, unit: !95, variables: !96)
...
!102 = distinct !DISubprogram(name: "bit_shifter", scope: !38, file: !38, line: 88, type: !61, isLocal: true, isDefinition: true, scopeLine: 89, flags: DIFlagPrototyped, isOptimized: true, unit: !48, variables: !103)
!103 = !{!104, !105, !106}
...
!112 = !DILocation(line: 147, column: 46, scope: !113)
!113 = distinct !DILexicalBlock(scope: !115, file: !114, line: 146, column: 14)
!114 = !DIFile(filename: "/home/local/ASUAD/sjdave/shail/ccf/scripts/CGRALib/cgra.c", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
!115 = distinct !DISubprogram(name: "runOnCGRA", scope: !114, file: !114, line: 143, type: !116, isLocal: false, isDefinition: true, scopeLine: 144, flags: DIFlagPrototyped, isOptimized: true, unit: !118, variables: !157)
...
!125 = distinct !DIGlobalVariable(name: "totalLoops", scope: !118, file: !126, line: 29, type: !121, isLocal: false, isDefinition: true)
!126 = !DIFile(filename: "/home/local/ASUAD/sjdave/shail/ccf/scripts/CGRALib/cgra.h", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
!127 = !DIGlobalVariableExpression(var: !128)
!128 = distinct !DIGlobalVariable(name: "thread_cond_cpu", scope: !118, file: !126, line: 32, type: !121, isLocal: false, isDefinition: true)
!129 = !DIGlobalVariableExpression(var: !130)
!130 = distinct !DIGlobalVariable(name: "thread_cond_cgra", scope: !118, file: !126, line: 33, type: !121, isLocal: false, isDefinition: true)
!131 = !DIGlobalVariableExpression(var: !132)
!132 = distinct !DIGlobalVariable(name: "thread_exit", scope: !118, file: !126, line: 34, type: !121, isLocal: false, isDefinition: true)
!133 = !DIGlobalVariableExpression(var: !134)
!134 = distinct !DIGlobalVariable(name: "dynamicTCVal", scope: !118, file: !126, line: 36, type: !17, isLocal: false, isDefinition: true)
!135 = !DIGlobalVariableExpression(var: !136)
!136 = distinct !DIGlobalVariable(name: "prolog", scope: !118, file: !126, line: 23, type: !120, isLocal: false, isDefinition: true)
!137 = !DIGlobalVariableExpression(var: !138)
!138 = distinct !DIGlobalVariable(name: "epilog", scope: !118, file: !126, line: 23, type: !120, isLocal: false, isDefinition: true)
!139 = !DIGlobalVariableExpression(var: !140)
!140 = distinct !DIGlobalVariable(name: "kernel", scope: !118, file: !126, line: 23, type: !120, isLocal: false, isDefinition: true)
!141 = !DIGlobalVariableExpression(var: !142)
!142 = distinct !DIGlobalVariable(name: "ArrPtr", scope: !118, file: !126, line: 24, type: !120, isLocal: false, isDefinition: true)
!143 = !DIGlobalVariableExpression(var: !144)
!144 = distinct !DIGlobalVariable(name: "prologPtr", scope: !118, file: !126, line: 26, type: !145, isLocal: false, isDefinition: true)
!145 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !16, size: 32)
!146 = !DIGlobalVariableExpression(var: !147)
!147 = distinct !DIGlobalVariable(name: "kernelPtr", scope: !118, file: !126, line: 26, type: !145, isLocal: false, isDefinition: true)
!148 = !DIGlobalVariableExpression(var: !149)
!149 = distinct !DIGlobalVariable(name: "epilogPtr", scope: !118, file: !126, line: 26, type: !145, isLocal: false, isDefinition: true)
!150 = !DIGlobalVariableExpression(var: !151)
!151 = distinct !DIGlobalVariable(name: "initCGRA", scope: !118, file: !126, line: 28, type: !122, isLocal: false, isDefinition: true)
!152 = !DIGlobalVariableExpression(var: !153)
!153 = distinct !DIGlobalVariable(name: "pth", scope: !118, file: !126, line: 31, type: !154, isLocal: false, isDefinition: true)
!154 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !155, line: 37, baseType: !156)
!155 = !DIFile(filename: "/usr/arm-linux-gnueabi/include/bits/pthreadtypes.h", directory: "/home/local/ASUAD/sjdave/shail/ccf/work/bitcount23")
!156 = !DIBasicType(name: "long unsigned int", size: 32, encoding: DW_ATE_unsigned)
!157 = !{!158}
!158 = !DILocalVariable(name: "arg", arg: 1, scope: !115, file: !114, line: 143, type: !55)
!159 = !{i32 4103}
!160 = !{i32 4211}
!161 = distinct !{!161, !162}
!162 = !DILocation(line: 158, column: 5, scope: !115)
!163 = distinct !{!163, !164}
!164 = !DILocation(line: 176, column: 41, scope: !165)
!165 = distinct !DISubprogram(name: "accelerateOnCGRA", scope: !114, file: !114, line: 162, type: !166, isLocal: false, isDefinition: true, scopeLine: 163, flags: DIFlagPrototyped, isOptimized: true, unit: !118, variables: !168)
!166 = !DISubroutineType(types: !167)
!167 = !{null, !121}
!168 = !{!169, !170, !171}
!169 = !DILocalVariable(name: "loopNo", arg: 1, scope: !165, file: !114, line: 162, type: !121)
!170 = !DILocalVariable(name: "result", scope: !165, file: !114, line: 164, type: !17)
!171 = !DILocalVariable(name: "configure", scope: !165, file: !114, line: 166, type: !17)
!172 = distinct !{!172, !173}
!173 = !DILocation(line: 204, column: 29, scope: !174)
!174 = distinct !DILexicalBlock(scope: !175, file: !114, line: 203, column: 3)
!175 = distinct !DISubprogram(name: "createCGRA", scope: !114, file: !114, line: 191, type: !176, isLocal: false, isDefinition: true, scopeLine: 192, isOptimized: true, unit: !118, variables: !178)
!176 = !DISubroutineType(types: !177)
!177 = !{null}
!178 = !{!179, !180}
!179 = !DILocalVariable(name: "result", scope: !175, file: !114, line: 193, type: !17)
!180 = !DILocalVariable(name: "i", scope: !175, file: !114, line: 194, type: !121)
